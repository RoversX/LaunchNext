    ...
    private init() {
        var builder: [AppLanguage: [LocalizationKey: String]] = [
            .english: [
                ...
                .kioskModeDescription: "Keep the launcher visible when clicking the background. Escape key and hotkey still work.",
        ...
        .portugueseBrazil: [
            ...
            .kioskModeTitle: "Modo quiosque",
            .kioskModeDescription: "Manter o lancador visivel ao clicar no fundo. Escape e o atalho continuam funcionando.",
            ...
            .loadingApplications: "正在加载应用…",
                ...
                .kioskModeTitle: "Kiosk 模式",
                .kioskModeDescription: "点击背景时保持启动器可见。Escape 键和快捷键仍可使用。",
            ...
            .loadingApplications: "Caricamento applicazioni…",
                ...
                .kioskModeTitle: "Modalita chiosco",
                .kioskModeDescription: "Il launcher rimane visibile quando si clicca sullo sfondo. Esc e la scorciatoia funzionano ancora.",
        ...
        builder[.japanese]?.merge([
            ...
            .kioskModeDescription: "背景をクリックしてもランチャーを閉じません。Escapeキーとホットキーは引き続き使用できます。",
        ...
        builder[.korean]?.merge([
            ...
            .kioskModeDescription: "배경 클릭 시 런처를 닫지 않습니다. Escape 키와 단축키는 계속 작동합니다.",
        ...
        builder[.vietnamese]?.merge([
            ...
            .kioskModeTitle: "Che do kiosk",
            .kioskModeDescription: "Giu launcher hien thi khi nhan vao nen. Phim Escape va phim tat van hoat dong.",
        ...
        builder[.french]?.merge([
            ...
            .kioskModeTitle: "Mode kiosque",
            .kioskModeDescription: "Le lanceur reste visible en cliquant sur l’arriere-plan. Echap et le raccourci fonctionnent toujours.",
        ...
        builder[.spanish]?.merge([
            ...
            .kioskModeTitle: "Modo quiosco",
            .kioskModeDescription: "El lanzador permanece visible al hacer clic en el fondo. Escape y el atajo siguen funcionando.",
            .settingsSectionGeneral: "General",
        ...
        builder[.czech]?.merge([
            ...
            .kioskModeTitle: "Rezim kiosku",
            .kioskModeDescription: "Launcher zustane viditelny po kliknuti na pozadi. Klavesa Escape a zkratka stale funguji.",
        ...
        builder[.german]?.merge([
            ...
            .kioskModeTitle: "Kioskmodus",
            .kioskModeDescription: "Der Launcher bleibt sichtbar, wenn Sie auf den Hintergrund klicken. Escape und Tastenkurzel funktionieren weiterhin.",
        ...
        builder[.russian]?.merge([
            ...
            .kioskModeTitle: "Режим киоска",
            .kioskModeDescription: "Лаунчер остаётся видимым при нажатии на фон. Escape и горячая клавиша по-прежнему работают.",
        ...
        hindiDictionary.merge([
            ...
            .kioskModeDescription: "पृष्ठभूमि पर क्लिक करने पर लॉन्चर दिखाई देता रहेगा। Escape कुंजी और हॉटकी अभी भी काम करती हैं।",
