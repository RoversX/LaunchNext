...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    static func resolveSystemDefault() -> AppLanguage {
        ...
        let lower = preferred.lowercased().replacingOccurrences(of: "_", with: "-")
...
enum LocalizationKey: String {
    ...
    case gestureInputDeviceShowAllTitle
    case gestureInputDeviceRecommendedBadge
    case gestureInputDeviceUnverifiedBadge
    case gestureInputDeviceNoRecommendedDescription
    case gestureInputDeviceUnverifiedWarning
    case gestureInputDeviceFamilyIDFormat
    ...
    case backgroundImageSourceTitleCompact
    case backgroundImageSourceCustomImageCompact
    case backgroundImageSourceDesktopPreview
    case wallpaperPreviewHint
    case backgroundImageSourceDesktopWallpaper
    case backgroundImageSourceCustomImage
    case wallpaperCaptureStatic
    case wallpaperCaptureGranted
    case wallpaperCaptureRequired
    case wallpaperCaptureAllow
    case wallpaperCaptureOpenSettings
    case wallpaperCaptureHint
    case chooseBackgroundImage
    case changeBackgroundImage
    case backgroundImageUnavailable
    case windowOpenAnimationTitle
    case windowMaxWidthTitle
    case windowMaxHeightTitle
    case windowSizeAutomatic
    case windowSizeLimitHint
    case windowShadowTitle
    case windowShadowHint
    case windowAnimationDurationLabel
    ...
    case trackpadVerticalDirectionTitle
    case trackpadVerticalDirectionNatural
    case trackpadVerticalDirectionReversed
    case hideDockOption
    ...
    case folderLiquidGlassTitle
    case folderLiquidGlassHint
    case folderQuickLaunchTitle
    case folderQuickLaunchHint
    ...
    case backgroundStyleOptionUnfiltered
    case backgroundStyleUnfilteredMemoryHint
    case backgroundStyleUnfilteredRequiresImage
    ...
    private init() {
        var builder: [AppLanguage: [LocalizationKey: String]] = [
            .english: [
                ...
                .backgroundImageTitle: "Use image background",
                .backgroundImageSourceTitle: "Background source",
                .backgroundImageSourceTitleCompact: "Source",
                .backgroundImageSourceDesktopPreview: "Static preview",
                .wallpaperPreviewHint: "No screen recording access needed. Animated wallpapers use a still preview that may differ from the desktop. Some wallpapers may not have a readable preview.",
                .backgroundImageSourceDesktopWallpaper: "Desktop wallpaper",
                .backgroundImageSourceCustomImage: "Custom image",
                .backgroundImageSourceCustomImageCompact: "Custom image",
                .wallpaperCaptureStatic: "This wallpaper image can be read without screen recording access.",
                .wallpaperCaptureGranted: "Screen recording access is enabled for desktop wallpaper.",
                .wallpaperCaptureRequired: "Capturing this wallpaper requires screen recording access.",
                .wallpaperCaptureAllow: "Allow wallpaper capture",
                .wallpaperCaptureOpenSettings: "Open System Settings",
                .wallpaperCaptureHint: "Captures one wallpaper snapshot when LaunchNext opens. macOS grants screen recording access; LaunchNext uses it only for wallpaper. Select this option again to allow access or open System Settings.",
                .chooseBackgroundImage: "Choose Image…",
                .changeBackgroundImage: "Change…",
                .backgroundImageUnavailable: "Image unavailable",
                .windowOpenAnimationTitle: "Window open/close animation",
                .windowMaxWidthTitle: "Maximum window width",
                .backgroundStyleOptionUnfiltered: "No effect",
                .backgroundStyleUnfilteredMemoryHint: "Sharper backgrounds may use more memory.",
                .backgroundStyleUnfilteredRequiresImage: "Enable image backgrounds to select No effect.",
                .windowMaxHeightTitle: "Maximum window height",
                .windowSizeAutomatic: "Automatic",
                .windowSizeLimitHint: "Size limits in points (pt). Leave blank or enter 0 for automatic sizing. Custom limits start at 800 wide and 600 high. The window keeps a 4:3 ratio; limits only reduce the automatic size.",
                .windowShadowTitle: "Window shadow",
                .windowShadowHint: "Turn off to help reduce Liquid Glass black-edge artifacts on some systems.",
                .windowAnimationDurationLabel: "Window animation duration",
                ...
                .reverseWheelDirectionCardDescription: "Mouse wheel reversals only affect wheel input. Trackpad and Magic Mouse vertical gestures use their own setting below.",
                .trackpadVerticalDirectionTitle: "Trackpad & Magic Mouse vertical direction",
                .trackpadVerticalDirectionNatural: "Finger moves up -> Next page / Show lower items",
                .trackpadVerticalDirectionReversed: "Finger moves up -> Previous page / Show upper items",
                ...
                .gestureInputDeviceShowAllTitle: "Show all input devices",
                .gestureInputDeviceRecommendedBadge: "Recommended",
                .gestureInputDeviceUnverifiedBadge: "Unverified",
                .gestureInputDeviceNoRecommendedDescription: "No recommended trackpads found. Turn on Show all input devices to test another multitouch device.",
                .gestureInputDeviceUnverifiedWarning: "This device may not be a trackpad. Select it only for testing.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Liquid Glass folder icons",
                .folderLiquidGlassHint: "Use clear Liquid Glass for folder icons with Core Animation rendering. Turn off to restore the original style.",
                .folderQuickLaunchTitle: "Folder Quick Launch",
                .folderQuickLaunchHint: "Right-click a folder to open its apps directly. Inside a folder, right-click an app to pin it to the top. Pins are layout settings; launch counts and usage history are not recorded.",
        ...
        .portugueseBrazil: [
            ...
            .reverseWheelDirectionCardDescription: "As inversões da roda do mouse afetam apenas a entrada da roda. Gestos verticais no trackpad e no Magic Mouse usam a configuração separada abaixo.",
            .trackpadVerticalDirectionTitle: "Direção vertical do trackpad e Magic Mouse",
            .trackpadVerticalDirectionNatural: "Dedo move para cima -> Próxima página / Mostrar itens abaixo",
            .trackpadVerticalDirectionReversed: "Dedo move para cima -> Página anterior / Mostrar itens acima",
            ...
            .backgroundImageTitle: "Usar imagem de fundo",
            .backgroundImageSourceTitle: "Fonte da imagem",
            .backgroundImageSourceTitleCompact: "Fonte",
            .backgroundImageSourceDesktopPreview: "Prévia estática",
            .wallpaperPreviewHint: "Não requer gravação de tela. Fundos animados usam uma prévia estática que pode diferir da mesa. Alguns fundos podem não ter uma prévia acessível.",
            .backgroundImageSourceDesktopWallpaper: "Papel de parede da mesa",
            .backgroundImageSourceCustomImage: "Imagem personalizada",
            .backgroundImageSourceCustomImageCompact: "Imagem personalizada",
            .wallpaperCaptureStatic: "Esta imagem de fundo pode ser lida sem permissão de gravação de tela.",
            .wallpaperCaptureGranted: "A gravação de tela está permitida para capturar a imagem de fundo.",
            .wallpaperCaptureRequired: "Capturar esta imagem de fundo requer permissão de gravação de tela.",
            .wallpaperCaptureAllow: "Permitir captura da imagem de fundo",
            .wallpaperCaptureOpenSettings: "Abrir Ajustes do Sistema",
            .wallpaperCaptureHint: "Captura uma imagem do fundo ao abrir o LaunchNext. O macOS concede acesso à gravação de tela; o LaunchNext usa esse acesso apenas para o fundo. Selecione esta opção novamente para permitir o acesso ou abrir os Ajustes do Sistema.",
            .chooseBackgroundImage: "Escolher imagem…",
            .changeBackgroundImage: "Alterar…",
            .backgroundImageUnavailable: "Imagem indisponível",
            .windowOpenAnimationTitle: "Animação de abrir/fechar janela",
            .windowMaxWidthTitle: "Largura máxima da janela",
            .backgroundStyleOptionUnfiltered: "Sem efeito",
            .backgroundStyleUnfilteredMemoryHint: "Fundos mais nítidos podem usar mais memória.",
            .backgroundStyleUnfilteredRequiresImage: "Ative o fundo com imagem para selecionar Sem efeito.",
            .windowMaxHeightTitle: "Altura máxima da janela",
            .windowSizeAutomatic: "Automático",
            .windowSizeLimitHint: "Limites em pontos (pt). Deixe vazio ou digite 0 para tamanho automático. Mínimos personalizados: 800 de largura e 600 de altura. A janela mantém a proporção 4:3; os limites apenas reduzem o tamanho automático.",
            .windowShadowTitle: "Sombra da janela",
            .windowShadowHint: "Desative para ajudar a reduzir bordas pretas no Liquid Glass em alguns sistemas.",
            .windowAnimationDurationLabel: "Duração da animação da janela",
            ...
            .gestureInputDeviceShowAllTitle: "Mostrar todos os dispositivos de entrada",
            .gestureInputDeviceRecommendedBadge: "Recomendado",
            .gestureInputDeviceUnverifiedBadge: "Não verificado",
            .gestureInputDeviceNoRecommendedDescription: "Nenhum trackpad recomendado encontrado. Ative Mostrar todos os dispositivos de entrada para testar outro dispositivo multitouch.",
            .gestureInputDeviceUnverifiedWarning: "Este dispositivo pode não ser um trackpad. Selecione-o apenas para testes.",
            .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
            ...
            .folderLiquidGlassTitle: "Pastas com Liquid Glass",
            .folderLiquidGlassHint: "Usa Liquid Glass transparente nos ícones de pastas com renderização Core Animation. Desative para restaurar o estilo original.",
            .folderQuickLaunchTitle: "Início rápido da pasta",
            .folderQuickLaunchHint: "Clique com o botão direito em uma pasta para abrir diretamente os apps nela. Dentro da pasta, clique com o botão direito em um app para fixá-lo no topo. As fixações fazem parte do layout; contagens de abertura e histórico de uso não são registrados.",
            ...
            .contextMenuShowInLayout: "Mostrar no layout",
            .contextMenuShowInFinder: "Mostrar no Finder",
            .contextMenuCopyAppPath: "Copiar caminho do app",
            .contextMenuPinToFolderQuickLaunchTop: "Fixar no topo do Início rápido",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Desafixar do topo do Início rápido",
            ...
            .vietnamese: [
                ...
                .reverseWheelDirectionCardDescription: "Đảo chiều bánh xe chuột chỉ ảnh hưởng đến đầu vào bánh xe. Cử chỉ dọc trên trackpad và Magic Mouse dùng cài đặt riêng bên dưới.",
                .trackpadVerticalDirectionTitle: "Hướng dọc của trackpad và Magic Mouse",
                .trackpadVerticalDirectionNatural: "Ngón tay di chuyển lên -> Trang tiếp / Hiện mục bên dưới",
                .trackpadVerticalDirectionReversed: "Ngón tay di chuyển lên -> Trang trước / Hiện mục bên trên",
            ...
            .loadingApplications: "Đang tải ứng dụng…",
                ...
                .backgroundImageTitle: "Dùng ảnh làm nền",
                .backgroundImageSourceTitle: "Nguồn ảnh nền",
                .backgroundImageSourceTitleCompact: "Nguồn",
                .backgroundImageSourceDesktopPreview: "Xem trước tĩnh",
                .wallpaperPreviewHint: "Không cần quyền ghi màn hình. Hình nền động dùng ảnh xem trước tĩnh có thể khác màn hình nền. Một số hình nền có thể không có ảnh xem trước đọc được.",
                .backgroundImageSourceDesktopWallpaper: "Hình nền màn hình",
                .backgroundImageSourceCustomImage: "Ảnh tùy chọn",
                .backgroundImageSourceCustomImageCompact: "Ảnh tùy chọn",
                .wallpaperCaptureStatic: "Có thể đọc trực tiếp ảnh nền này mà không cần quyền ghi màn hình.",
                .wallpaperCaptureGranted: "Đã cấp quyền ghi màn hình để chụp hình nền.",
                .wallpaperCaptureRequired: "Cần quyền ghi màn hình để chụp hình nền này.",
                .wallpaperCaptureAllow: "Cho phép chụp hình nền",
                .wallpaperCaptureOpenSettings: "Mở Cài đặt hệ thống",
                .wallpaperCaptureHint: "Chụp một ảnh hình nền khi mở LaunchNext. macOS cấp quyền ghi màn hình; LaunchNext chỉ dùng quyền này cho hình nền. Chọn lại tùy chọn này để cấp quyền hoặc mở Cài đặt hệ thống.",
                .chooseBackgroundImage: "Chọn ảnh…",
                .changeBackgroundImage: "Thay đổi…",
                .backgroundImageUnavailable: "Ảnh không khả dụng",
                .windowOpenAnimationTitle: "Hoạt ảnh mở/đóng cửa sổ",
                .windowMaxWidthTitle: "Chiều rộng cửa sổ tối đa",
                .backgroundStyleOptionUnfiltered: "Không hiệu ứng",
                .backgroundStyleUnfilteredMemoryHint: "Hình nền rõ nét hơn có thể dùng nhiều bộ nhớ hơn.",
                .backgroundStyleUnfilteredRequiresImage: "Bật hình nền để chọn Không hiệu ứng.",
                .windowMaxHeightTitle: "Chiều cao cửa sổ tối đa",
                .windowSizeAutomatic: "Tự động",
                .windowSizeLimitHint: "Giới hạn theo điểm (pt). Để trống hoặc nhập 0 để tự động. Giới hạn tùy chỉnh tối thiểu: rộng 800, cao 600. Cửa sổ giữ tỷ lệ 4:3; giới hạn chỉ giảm kích thước tự động.",
                .windowShadowTitle: "Bóng cửa sổ",
                .windowShadowHint: "Tắt để giúp giảm lỗi viền đen của Liquid Glass trên một số hệ thống.",
                .windowAnimationDurationLabel: "Thời lượng hoạt ảnh cửa sổ",
                ...
                .gestureInputDeviceShowAllTitle: "Hiển thị tất cả thiết bị nhập",
                .gestureInputDeviceRecommendedBadge: "Được đề xuất",
                .gestureInputDeviceUnverifiedBadge: "Chưa xác minh",
                .gestureInputDeviceNoRecommendedDescription: "Không tìm thấy trackpad được đề xuất. Bật Hiển thị tất cả thiết bị nhập để thử thiết bị đa chạm khác.",
                .gestureInputDeviceUnverifiedWarning: "Thiết bị này có thể không phải trackpad. Chỉ chọn để thử nghiệm.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Biểu tượng thư mục Liquid Glass",
                .folderLiquidGlassHint: "Dùng Liquid Glass trong suốt cho biểu tượng thư mục khi kết xuất bằng Core Animation. Tắt để khôi phục kiểu ban đầu.",
                .folderQuickLaunchTitle: "Khởi chạy nhanh từ thư mục",
                .folderQuickLaunchHint: "Nhấp chuột phải vào thư mục để mở trực tiếp các ứng dụng bên trong. Trong thư mục, nhấp chuột phải vào ứng dụng để ghim lên đầu. Ghim là một phần của bố cục; số lần mở và lịch sử sử dụng không được ghi lại.",
            ...
            .loadingApplications: "正在加载应用…",
                ...
                .backgroundImageTitle: "使用图片背景",
                .backgroundImageSourceTitle: "背景来源",
                .backgroundImageSourceTitleCompact: "背景来源",
                .backgroundImageSourceDesktopPreview: "静态预览",
                .wallpaperPreviewHint: "无需录屏权限。动态壁纸使用静态预览，可能与桌面画面不同；部分壁纸可能无法读取预览。",
                .backgroundImageSourceDesktopWallpaper: "桌面壁纸",
                .backgroundImageSourceCustomImage: "自选图片",
                .backgroundImageSourceCustomImageCompact: "自选图片",
                .wallpaperCaptureStatic: "这张壁纸图片可以直接读取，无需录屏权限。",
                .wallpaperCaptureGranted: "已允许获取桌面壁纸。",
                .wallpaperCaptureRequired: "获取这张壁纸需要录屏权限。",
                .wallpaperCaptureAllow: "允许获取桌面壁纸",
                .wallpaperCaptureOpenSettings: "打开系统设置",
                .wallpaperCaptureHint: "打开 LaunchNext 时获取一张壁纸快照。macOS 授予屏幕录制权限；LaunchNext 仅用于获取壁纸。再次点击此选项可授权或前往系统设置。",
                .chooseBackgroundImage: "选择图片…",
                .changeBackgroundImage: "更换…",
                .backgroundImageUnavailable: "图片不可用",
                .windowOpenAnimationTitle: "窗口开关动画",
                .windowMaxWidthTitle: "窗口最大宽度",
                .backgroundStyleOptionUnfiltered: "无效果",
                .backgroundStyleUnfilteredMemoryHint: "更清晰的背景可能增加内存占用。",
                .backgroundStyleUnfilteredRequiresImage: "开启“使用图片背景”后可选择无效果。",
                .windowMaxHeightTitle: "窗口最大高度",
                .windowSizeAutomatic: "自动",
                .windowSizeLimitHint: "单位为逻辑点（pt）。留空或输入 0 使用自动大小；自定义上限最低为宽 800、高 600。窗口保持 4:3，上限只会缩小自动计算的尺寸。",
                .windowShadowTitle: "窗口阴影",
                .windowShadowHint: "关闭可缓解部分系统上的液态玻璃黑边。",
                .windowAnimationDurationLabel: "窗口动画时长",
                ...
                .reverseWheelDirectionCardDescription: "鼠标滚轮反转仅影响滚轮输入；触摸板和 Magic Mouse 纵向手势使用下方单独设置。",
                .trackpadVerticalDirectionTitle: "触摸板与 Magic Mouse 纵向方向",
                .trackpadVerticalDirectionNatural: "手指向上移动 -> 下一页 / 查看下方内容",
                .trackpadVerticalDirectionReversed: "手指向上移动 -> 上一页 / 查看上方内容",
                ...
                .gestureInputDeviceShowAllTitle: "显示所有输入设备",
                .gestureInputDeviceRecommendedBadge: "推荐",
                .gestureInputDeviceUnverifiedBadge: "未验证",
                .gestureInputDeviceNoRecommendedDescription: "未找到推荐的触控板。打开“显示所有输入设备”可测试其他多点触控设备。",
                .gestureInputDeviceUnverifiedWarning: "此设备可能不是触控板，仅建议用于测试。",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "文件夹液态玻璃",
                .folderLiquidGlassHint: "为 Core Animation 渲染的文件夹图标使用通透液态玻璃。关闭后恢复原有样式。",
                .folderQuickLaunchTitle: "文件夹快捷启动",
                .folderQuickLaunchHint: "右键文件夹即可直接打开其中的应用；在文件夹内右键应用可将其固定到列表顶部。置顶属于布局设置，不会记录启动次数或使用历史。",
                ...
                .languageNameChinese: "简体中文",
                .languageNameTraditionalChinese: "繁体中文",
            ...
            .japanese: [
                ...
                .reverseWheelDirectionCardDescription: "マウスホイールの反転はホイール入力にのみ適用されます。トラックパッドとMagic Mouseの縦ジェスチャは下の個別設定を使用します。",
                .trackpadVerticalDirectionTitle: "トラックパッドとMagic Mouseの縦方向",
                .trackpadVerticalDirectionNatural: "指を上に動かす -> 次のページ / 下の項目を表示",
                .trackpadVerticalDirectionReversed: "指を上に動かす -> 前のページ / 上の項目を表示",
            ...
            .loadingApplications: "アプリを読み込み中…",
                ...
                .backgroundImageTitle: "画像を背景に使用",
                .backgroundImageSourceTitle: "背景画像のソース",
                .backgroundImageSourceTitleCompact: "ソース",
                .backgroundImageSourceDesktopPreview: "静止プレビュー",
                .wallpaperPreviewHint: "画面収録の許可は不要です。動く壁紙には静止プレビューを使用するため、実際の画面と異なる場合があります。プレビューを読み込めない壁紙もあります。",
                .backgroundImageSourceDesktopWallpaper: "デスクトップの壁紙",
                .backgroundImageSourceCustomImage: "カスタム画像",
                .backgroundImageSourceCustomImageCompact: "カスタム画像",
                .wallpaperCaptureStatic: "この壁紙画像は、画面収録の許可なしで直接読み込めます。",
                .wallpaperCaptureGranted: "壁紙を取得するための画面収録が許可されています。",
                .wallpaperCaptureRequired: "この壁紙を取得するには、画面収録の許可が必要です。",
                .wallpaperCaptureAllow: "壁紙の取得を許可",
                .wallpaperCaptureOpenSettings: "システム設定を開く",
                .wallpaperCaptureHint: "LaunchNext を開く際に壁紙を1枚取得します。macOS は画面収録を許可しますが、LaunchNext は壁紙の取得にのみ使用します。この項目を再度選ぶと、許可またはシステム設定へ進めます。",
                .chooseBackgroundImage: "画像を選択…",
                .changeBackgroundImage: "変更…",
                .backgroundImageUnavailable: "画像を利用できません",
                .windowOpenAnimationTitle: "ウィンドウ開閉アニメーション",
                .windowMaxWidthTitle: "ウィンドウの最大幅",
                .backgroundStyleOptionUnfiltered: "効果なし",
                .backgroundStyleUnfilteredMemoryHint: "鮮明な背景はメモリ使用量が増える場合があります。",
                .backgroundStyleUnfilteredRequiresImage: "画像背景をオンにすると「効果なし」を選択できます。",
                .windowMaxHeightTitle: "ウィンドウの最大高さ",
                .windowSizeAutomatic: "自動",
                .windowSizeLimitHint: "単位はポイント（pt）です。空欄または 0 で自動サイズになります。指定できる上限の最小値は幅 800、高さ 600 です。縦横比は 4:3 を維持し、自動サイズより小さくする場合にのみ適用されます。",
                .windowShadowTitle: "ウィンドウの影",
                .windowShadowHint: "オフにすると、一部のシステムで Liquid Glass の黒い縁の表示不具合を軽減できる場合があります。",
                .windowAnimationDurationLabel: "ウィンドウアニメーション時間",
                ...
                .gestureInputDeviceShowAllTitle: "すべての入力デバイスを表示",
                .gestureInputDeviceRecommendedBadge: "推奨",
                .gestureInputDeviceUnverifiedBadge: "未確認",
                .gestureInputDeviceNoRecommendedDescription: "推奨トラックパッドが見つかりません。ほかのマルチタッチデバイスを試すには、すべての入力デバイスを表示してください。",
                .gestureInputDeviceUnverifiedWarning: "このデバイスはトラックパッドではない可能性があります。テスト目的でのみ選択してください。",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "フォルダーの Liquid Glass",
                .folderLiquidGlassHint: "Core Animation 描画のフォルダーアイコンに透明な Liquid Glass を使います。オフにすると元のスタイルに戻ります。",
                .folderQuickLaunchTitle: "フォルダーからクイック起動",
                .folderQuickLaunchHint: "フォルダーを右クリックして中のアプリを直接開けます。フォルダー内でアプリを右クリックすると一覧の先頭に固定できます。固定はレイアウト設定であり、起動回数や使用履歴は記録されません。",
            ...
            .korean: [
                ...
                .reverseWheelDirectionCardDescription: "마우스 휠 반전은 휠 입력에만 적용됩니다. 트랙패드와 Magic Mouse의 세로 제스처는 아래의 별도 설정을 사용합니다.",
                .trackpadVerticalDirectionTitle: "트랙패드 및 Magic Mouse 세로 방향",
                .trackpadVerticalDirectionNatural: "손가락을 위로 이동 -> 다음 페이지 / 아래 항목 보기",
                .trackpadVerticalDirectionReversed: "손가락을 위로 이동 -> 이전 페이지 / 위 항목 보기",
            ...
            .loadingApplications: "앱을 불러오는 중…",
                ...
                .backgroundImageTitle: "이미지 배경 사용",
                .backgroundImageSourceTitle: "배경 이미지 소스",
                .backgroundImageSourceTitleCompact: "출처",
                .backgroundImageSourceDesktopPreview: "정적 미리보기",
                .wallpaperPreviewHint: "화면 녹화 권한이 필요하지 않습니다. 움직이는 배경화면은 실제 화면과 다를 수 있는 정적 미리보기를 사용합니다. 일부 배경화면은 미리보기를 읽을 수 없습니다.",
                .backgroundImageSourceDesktopWallpaper: "데스크탑 배경화면",
                .backgroundImageSourceCustomImage: "사용자 지정 이미지",
                .backgroundImageSourceCustomImageCompact: "사용자 지정 이미지",
                .wallpaperCaptureStatic: "이 배경화면 이미지는 화면 녹화 권한 없이 직접 읽을 수 있습니다.",
                .wallpaperCaptureGranted: "배경화면을 캡처하기 위한 화면 녹화 권한이 허용되었습니다.",
                .wallpaperCaptureRequired: "이 배경화면을 캡처하려면 화면 녹화 권한이 필요합니다.",
                .wallpaperCaptureAllow: "배경화면 캡처 허용",
                .wallpaperCaptureOpenSettings: "시스템 설정 열기",
                .wallpaperCaptureHint: "LaunchNext를 열 때 배경화면 한 장을 캡처합니다. macOS는 화면 녹화 권한을 부여하며 LaunchNext는 이를 배경화면에만 사용합니다. 이 옵션을 다시 선택하여 권한을 허용하거나 시스템 설정을 여세요.",
                .chooseBackgroundImage: "이미지 선택…",
                .changeBackgroundImage: "변경…",
                .backgroundImageUnavailable: "이미지를 사용할 수 없음",
                .windowOpenAnimationTitle: "창 열기/닫기 애니메이션",
                .windowMaxWidthTitle: "창 최대 너비",
                .backgroundStyleOptionUnfiltered: "효과 없음",
                .backgroundStyleUnfilteredMemoryHint: "더 선명한 배경은 메모리를 더 많이 사용할 수 있습니다.",
                .backgroundStyleUnfilteredRequiresImage: "이미지 배경을 켜면 효과 없음을 선택할 수 있습니다.",
                .windowMaxHeightTitle: "창 최대 높이",
                .windowSizeAutomatic: "자동",
                .windowSizeLimitHint: "단위는 포인트(pt)입니다. 비워 두거나 0을 입력하면 자동 크기를 사용합니다. 사용자 지정 한도의 최솟값은 너비 800, 높이 600입니다. 창은 4:3 비율을 유지하며 한도는 자동 크기를 줄일 때만 적용됩니다.",
                .windowShadowTitle: "창 그림자",
                .windowShadowHint: "끄면 일부 시스템에서 Liquid Glass에 검은 테두리가 나타나는 현상을 줄일 수 있습니다.",
                .windowAnimationDurationLabel: "창 애니메이션 길이",
                ...
                .gestureInputDeviceShowAllTitle: "모든 입력 장치 표시",
                .gestureInputDeviceRecommendedBadge: "권장",
                .gestureInputDeviceUnverifiedBadge: "미확인",
                .gestureInputDeviceNoRecommendedDescription: "권장 트랙패드를 찾을 수 없습니다. 다른 멀티터치 장치를 테스트하려면 모든 입력 장치 표시를 켜세요.",
                .gestureInputDeviceUnverifiedWarning: "이 장치는 트랙패드가 아닐 수 있습니다. 테스트용으로만 선택하세요.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "폴더 Liquid Glass",
                .folderLiquidGlassHint: "Core Animation으로 렌더링하는 폴더 아이콘에 투명한 Liquid Glass를 사용합니다. 끄면 기존 스타일로 돌아갑니다.",
                .folderQuickLaunchTitle: "폴더 빠른 실행",
                .folderQuickLaunchHint: "폴더를 오른쪽 클릭해 안의 앱을 바로 열 수 있습니다. 폴더 안에서 앱을 오른쪽 클릭하면 목록 맨 위에 고정할 수 있습니다. 고정은 레이아웃 설정이며 실행 횟수나 사용 기록은 저장하지 않습니다.",
            ...
            .french: [
                ...
                .reverseWheelDirectionCardDescription: "Les inversions de molette n'affectent que l'entrée de la molette. Les gestes verticaux du trackpad et de la Magic Mouse utilisent le réglage séparé ci-dessous.",
                .trackpadVerticalDirectionTitle: "Direction verticale du trackpad et de la Magic Mouse",
                .trackpadVerticalDirectionNatural: "Doigt vers le haut -> Page suivante / Afficher les éléments plus bas",
                .trackpadVerticalDirectionReversed: "Doigt vers le haut -> Page précédente / Afficher les éléments plus haut",
            ...
            .loadingApplications: "Chargement des applications…",
                ...
                .backgroundImageTitle: "Utiliser une image d’arrière-plan",
                .backgroundImageSourceTitle: "Source de l’image",
                .backgroundImageSourceTitleCompact: "Source",
                .backgroundImageSourceDesktopPreview: "Aperçu fixe",
                .wallpaperPreviewHint: "Aucune autorisation d’enregistrement de l’écran requise. Les fonds animés utilisent un aperçu fixe qui peut différer du bureau. Certains aperçus peuvent être indisponibles.",
                .backgroundImageSourceDesktopWallpaper: "Fond d’écran du bureau",
                .backgroundImageSourceCustomImage: "Image personnalisée",
                .backgroundImageSourceCustomImageCompact: "Image personnalisée",
                .wallpaperCaptureStatic: "Cette image de fond peut être lue sans autorisation d’enregistrement de l’écran.",
                .wallpaperCaptureGranted: "L’enregistrement de l’écran est autorisé pour capturer le fond d’écran.",
                .wallpaperCaptureRequired: "La capture de ce fond d’écran nécessite l’autorisation d’enregistrer l’écran.",
                .wallpaperCaptureAllow: "Autoriser la capture du fond d’écran",
                .wallpaperCaptureOpenSettings: "Ouvrir Réglages Système",
                .wallpaperCaptureHint: "Capture une image du fond à l’ouverture de LaunchNext. macOS autorise l’enregistrement de l’écran ; LaunchNext l’utilise uniquement pour le fond. Sélectionnez à nouveau cette option pour autoriser l’accès ou ouvrir Réglages Système.",
                .chooseBackgroundImage: "Choisir une image…",
                .changeBackgroundImage: "Modifier…",
                .backgroundImageUnavailable: "Image indisponible",
                .windowOpenAnimationTitle: "Animation d’ouverture/fermeture de la fenêtre",
                .windowMaxWidthTitle: "Largeur maximale de la fenêtre",
                .backgroundStyleOptionUnfiltered: "Sans effet",
                .backgroundStyleUnfilteredMemoryHint: "Un arrière-plan plus net peut utiliser davantage de mémoire.",
                .backgroundStyleUnfilteredRequiresImage: "Activez le fond d’image pour sélectionner Sans effet.",
                .windowMaxHeightTitle: "Hauteur maximale de la fenêtre",
                .windowSizeAutomatic: "Automatique",
                .windowSizeLimitHint: "Limites en points (pt). Laissez vide ou saisissez 0 pour la taille automatique. Minimums personnalisés : largeur 800, hauteur 600. La fenêtre conserve le format 4:3 ; les limites réduisent uniquement la taille automatique.",
                .windowShadowTitle: "Ombre de la fenêtre",
                .windowShadowHint: "Désactivez cette option pour atténuer les bordures noires du Liquid Glass sur certains systèmes.",
                .windowAnimationDurationLabel: "Durée de l’animation de la fenêtre",
                ...
                .gestureInputDeviceShowAllTitle: "Afficher tous les périphériques d’entrée",
                .gestureInputDeviceRecommendedBadge: "Recommandé",
                .gestureInputDeviceUnverifiedBadge: "Non vérifié",
                .gestureInputDeviceNoRecommendedDescription: "Aucun trackpad recommandé trouvé. Activez Afficher tous les périphériques d’entrée pour tester un autre périphérique multitouch.",
                .gestureInputDeviceUnverifiedWarning: "Ce périphérique n’est peut-être pas un trackpad. Sélectionnez-le uniquement pour tester.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Dossiers Liquid Glass",
                .folderLiquidGlassHint: "Utilise un Liquid Glass transparent pour les icônes de dossiers avec le rendu Core Animation. Désactivez pour retrouver le style initial.",
                .folderQuickLaunchTitle: "Lancement rapide depuis les dossiers",
                .folderQuickLaunchHint: "Effectuez un clic droit sur un dossier pour ouvrir directement ses apps. Dans le dossier, effectuez un clic droit sur une app pour l’épingler en haut. Les épingles font partie de la disposition ; aucun nombre de lancements ni historique d’utilisation n’est enregistré.",
            ...
            .spanish: [
                ...
                .reverseWheelDirectionCardDescription: "La inversión de la rueda del ratón solo afecta a la entrada de la rueda. Los gestos verticales del trackpad y Magic Mouse usan el ajuste separado de abajo.",
                .trackpadVerticalDirectionTitle: "Dirección vertical del trackpad y Magic Mouse",
                .trackpadVerticalDirectionNatural: "Dedo hacia arriba -> Página siguiente / Ver elementos inferiores",
                .trackpadVerticalDirectionReversed: "Dedo hacia arriba -> Página anterior / Ver elementos superiores",
            ...
            .loadingApplications: "Cargando aplicaciones…",
                ...
                .backgroundImageTitle: "Usar una imagen de fondo",
                .backgroundImageSourceTitle: "Fuente de la imagen",
                .backgroundImageSourceTitleCompact: "Origen",
                .backgroundImageSourceDesktopPreview: "Vista previa estática",
                .wallpaperPreviewHint: "No requiere permiso de grabación de pantalla. Los fondos animados usan una vista previa fija que puede diferir del escritorio. Algunos fondos pueden no tener una vista previa disponible.",
                .backgroundImageSourceDesktopWallpaper: "Fondo de escritorio",
                .backgroundImageSourceCustomImage: "Imagen personalizada",
                .backgroundImageSourceCustomImageCompact: "Imagen personalizada",
                .wallpaperCaptureStatic: "Esta imagen de fondo puede leerse sin permiso para grabar la pantalla.",
                .wallpaperCaptureGranted: "La grabación de pantalla está autorizada para capturar el fondo de escritorio.",
                .wallpaperCaptureRequired: "Capturar este fondo de escritorio requiere permiso para grabar la pantalla.",
                .wallpaperCaptureAllow: "Permitir capturar el fondo",
                .wallpaperCaptureOpenSettings: "Abrir Ajustes del Sistema",
                .wallpaperCaptureHint: "Captura una imagen del fondo al abrir LaunchNext. macOS concede permiso de grabación de pantalla; LaunchNext lo usa solo para el fondo. Vuelve a seleccionar esta opción para autorizar el acceso o abrir Ajustes del Sistema.",
                .chooseBackgroundImage: "Seleccionar imagen…",
                .changeBackgroundImage: "Cambiar…",
                .backgroundImageUnavailable: "Imagen no disponible",
                .windowOpenAnimationTitle: "Animación de apertura/cierre de la ventana",
                .windowMaxWidthTitle: "Ancho máximo de la ventana",
                .backgroundStyleOptionUnfiltered: "Sin efecto",
                .backgroundStyleUnfilteredMemoryHint: "Los fondos más nítidos pueden usar más memoria.",
                .backgroundStyleUnfilteredRequiresImage: "Activa el fondo de imagen para seleccionar Sin efecto.",
                .windowMaxHeightTitle: "Alto máximo de la ventana",
                .windowSizeAutomatic: "Automático",
                .windowSizeLimitHint: "Límites en puntos (pt). Deja el campo vacío o introduce 0 para el tamaño automático. Mínimos personalizados: 800 de ancho y 600 de alto. La ventana mantiene la proporción 4:3; los límites solo reducen el tamaño automático.",
                .windowShadowTitle: "Sombra de la ventana",
                .windowShadowHint: "Desactívala para ayudar a reducir los bordes negros de Liquid Glass en algunos sistemas.",
                .windowAnimationDurationLabel: "Duración de la animación de la ventana",
                .hideDockOption: "Ocultar Dock",
                ...
                .gestureInputDeviceBuiltInBadge: "Integrado",
                .gestureInputDeviceExternalBadge: "Externo",
                .gestureInputDeviceShowAllTitle: "Mostrar todos los dispositivos de entrada",
                .gestureInputDeviceRecommendedBadge: "Recomendado",
                .gestureInputDeviceUnverifiedBadge: "No verificado",
                .gestureInputDeviceNoRecommendedDescription: "No se encontraron trackpads recomendados. Activa Mostrar todos los dispositivos de entrada para probar otro dispositivo multitáctil.",
                .gestureInputDeviceUnverifiedWarning: "Puede que este dispositivo no sea un trackpad. Selecciónalo solo para pruebas.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Carpetas con Liquid Glass",
                .folderLiquidGlassHint: "Usa Liquid Glass transparente en los iconos de carpeta con renderizado Core Animation. Desactívalo para recuperar el estilo original.",
                .folderQuickLaunchTitle: "Inicio rápido desde carpetas",
                .folderQuickLaunchHint: "Haz clic derecho en una carpeta para abrir directamente sus apps. Dentro de la carpeta, haz clic derecho en una app para fijarla arriba. Los elementos fijados forman parte del diseño; no se registran recuentos de apertura ni el historial de uso.",
            ...
            .italian: [
                ...
                .renameSearchPlaceholder: "Cerca apps",
                ...
                .customIconReset: "Ripristina",
                .customIconHint: "I file PNG/ICNS a 512×512 offrono la resa migliore. Le modifiche si applicano all'istante.",
                .customIconError: "Impossibile caricare l'immagine selezionata.",
                .pageIndicatorOffsetLabel: "Spaziatura indicatore di pagina",
                .pageIndicatorTopPaddingLabel: "Distanza superiore indicatore di pagina",
                .layoutModeScopeFullscreen: "Classico",
                ...
                .customOption: "Regola",
                .perDisplayIndicatorPositionTitle: "Posizione dell'indicatore per singolo schermo",
                ...
                .folderWindowSizeHint: "Applicato solo in modalità finestra; la modalità classica a schermo intero usa un layout fisso.",
                .appTitle: "LaunchNext",
                ...
                .backgroundImageTitle: "Usa un’immagine come sfondo",
                .backgroundImageSourceTitle: "Origine immagine",
                .backgroundImageSourceTitleCompact: "Origine",
                .backgroundImageSourceDesktopPreview: "Anteprima statica",
                .wallpaperPreviewHint: "Non richiede la registrazione dello schermo. Gli sfondi animati usano un’anteprima fissa che può differire dalla Scrivania. Alcune anteprime potrebbero non essere disponibili.",
                .backgroundImageSourceDesktopWallpaper: "Sfondo della Scrivania",
                .backgroundImageSourceCustomImage: "Immagine personalizzata",
                .backgroundImageSourceCustomImageCompact: "Immagine personalizzata",
                .wallpaperCaptureStatic: "Questa immagine di sfondo può essere letta senza il permesso di registrare lo schermo.",
                .wallpaperCaptureGranted: "La registrazione dello schermo è consentita per acquisire lo sfondo.",
                .wallpaperCaptureRequired: "Per acquisire questo sfondo serve il permesso di registrare lo schermo.",
                .wallpaperCaptureAllow: "Consenti acquisizione dello sfondo",
                .wallpaperCaptureOpenSettings: "Apri Impostazioni di Sistema",
                .wallpaperCaptureHint: "Acquisisce un’immagine dello sfondo all’apertura di LaunchNext. macOS autorizza la registrazione dello schermo; LaunchNext la usa solo per lo sfondo. Seleziona di nuovo questa opzione per autorizzare l’accesso o aprire Impostazioni di Sistema.",
                .chooseBackgroundImage: "Scegli immagine…",
                .changeBackgroundImage: "Cambia…",
                .backgroundImageUnavailable: "Immagine non disponibile",
                .windowOpenAnimationTitle: "Animazione di apertura/chiusura della finestra",
                .windowMaxWidthTitle: "Larghezza massima finestra",
                .backgroundStyleOptionUnfiltered: "Nessun effetto",
                .backgroundStyleUnfilteredMemoryHint: "Sfondi più nitidi possono usare più memoria.",
                .backgroundStyleUnfilteredRequiresImage: "Attiva lo sfondo immagine per selezionare Nessun effetto.",
                .windowMaxHeightTitle: "Altezza massima finestra",
                .windowSizeAutomatic: "Automatico",
                .windowSizeLimitHint: "Limiti in punti (pt). Lascia vuoto o inserisci 0 per la dimensione automatica. Minimi personalizzati: larghezza 800, altezza 600. La finestra mantiene il rapporto 4:3; i limiti riducono solo la dimensione automatica.",
                .windowShadowTitle: "Ombra della finestra",
                .windowShadowHint: "Disattiva per attenuare i bordi neri di Liquid Glass su alcuni sistemi.",
                .windowAnimationDurationLabel: "Durata animazione finestra",
                ...
                .reverseWheelDirectionCardDescription: "Le inversioni della rotellina del mouse influiscono solo sull'input della rotellina. I gesti verticali del trackpad e del Magic Mouse usano l'impostazione separata qui sotto.",
                .trackpadVerticalDirectionTitle: "Direzione verticale di trackpad e Magic Mouse",
                .trackpadVerticalDirectionNatural: "Dito verso l'alto -> Pagina successiva / Mostra elementi in basso",
                .trackpadVerticalDirectionReversed: "Dito verso l'alto -> Pagina precedente / Mostra elementi in alto",
                ...
                .activePressEffect: "Feedback al clic",
                .activePressScale: "Fattore di riduzione al clic",
                .animationDurationLabel: "Durata animazione di scorrimento",
                .gridSizeChangeWarning: "Modificare la dimensione della griglia potrebbe riposizionare alcune icone.",
                .pageIndicatorHint: "Se la spaziatura verticale sembra ridotta, regola l'offset dell'indicatore di pagina qui sotto.",
                .rememberPageTitle: "Ricorda l'ultima pagina aperta",
                .globalShortcutTitle: "Scorciatoie e gesti",
                ...
                .dockDragSectionDescription: "Scegli dove attivare il trascinamento nel Dock e quanto devi trascinare prima che LaunchNext passi il controllo a macOS.",
                .dockDragEnabledTitle: "Abilita trascinamento nel Dock",
                .dockDragSideTitle: "Posizione del Dock",
                ...
                .hotCornerSectionTitle: "Angoli attivi",
                .hotCornerSectionDescription: "Apri LaunchNext quando il puntatore raggiunge l'angolo dello schermo selezionato.",
                .hotCornerEnabledTitle: "Abilita angoli attivi",
                .hotCornerToggleWhenOpenTitle: "Chiudi se già aperto",
                .hotCornerPositionTitle: "Angolo",
                .hotCornerTriggerDelayTitle: "Ritardo di attivazione",
                .hotCornerHitboxSizeTitle: "Zona di attivazione",
                .gestureSectionTitle: "Gesture",
                .gestureSectionDescription: "Gesti sperimentali di pizzico e tocco sul trackpad per LaunchNext.",
                .gestureEnabledTitle: "Attiva gesto di pizzico",
                .gestureCloseOnPinchOutTitle: "Chiudi con gesto di allargamento",
                .gestureTapActionTitle: "Gesture tocco",
                .gestureFingerCountTitle: "Dita per la gesture",
                ...
                .gestureInputDeviceTitle: "Dispositivo di input per le gesture",
                .gestureInputDeviceModeAuto: "Auto",
                .gestureInputDeviceModeSelected: "Dispositivi selezionati",
                .gestureInputDeviceAutoDescription: "Usa il primo trackpad che rileva una gesture valida.",
                ...
                .gestureInputDeviceShowAllTitle: "Mostra tutti i dispositivi di input",
                .gestureInputDeviceRecommendedBadge: "Consigliato",
                .gestureInputDeviceUnverifiedBadge: "Non verificato",
                .gestureInputDeviceNoRecommendedDescription: "Nessun trackpad consigliato trovato. Attiva Mostra tutti i dispositivi di input per provare un altro dispositivo multitouch.",
                .gestureInputDeviceUnverifiedWarning: "Questo dispositivo potrebbe non essere un trackpad. Selezionalo solo per test.",
                .gestureInputDeviceFamilyIDFormat: "ID famiglia",
                .gestureInputDeviceUnavailableDescription: "Alcuni dispositivi selezionati non sono al momento disponibili. Riconnettili o scegli un altro trackpad.",
                ...
                .importTip: "Suggerimento: fai clic su ‘Importa Launchpad di sistema’ per importare direttamente.",
                .onboardingTitle: "Prepara LaunchNext",
                .onboardingSubtitle: "Scegli un'azione di configurazione prima di caricare e mostrare tutte le icone delle app.",
                ...
                .scanSourcesMissingBadge: "Offline",
                .scanSourcesFuzzySearchTitle: "Ricerca approssimativa",
                .scanSourcesFuzzySearchDescription: "Usa la corrispondenza approssimativa nei risultati di ricerca del launcher.",
                ...
                .folderLiquidGlassTitle: "Cartelle Liquid Glass",
                .folderLiquidGlassHint: "Usa Liquid Glass trasparente per le icone delle cartelle con rendering Core Animation. Disattiva per ripristinare lo stile originale.",
                .folderQuickLaunchTitle: "Avvio rapido dalle cartelle",
                .folderQuickLaunchHint: "Fai clic destro su una cartella per aprire direttamente le app contenute. Nella cartella, fai clic destro su un’app per fissarla in alto. Gli elementi fissati fanno parte del layout; non vengono registrati conteggi di avvio o cronologia d’uso.",
                ...
                .sidebarIconSizeTitle: "Dimensioni icone barra laterale",
                .sidebarIconSizeLarge: "Grandi",
                .sidebarIconSizeMedium: "Medie",
                .languageNameSystem: "Segui sistema",
                .languageNameEnglish: "Inglese",
                .languageNameChinese: "Cinese",
                .languageNameTraditionalChinese: "Cinese tradizionale",
                ...
                .languageNameHindi: "Hindi",
                .languageNameVietnamese: "Vietnamita",
                .languageNamePortugueseBrazil: "Portoghese (Brasile)",
            ...
            .czech: [
                ...
                .reverseWheelDirectionCardDescription: "Obrácení kolečka myši ovlivňuje jen vstup z kolečka. Svislá gesta trackpadu a Magic Mouse používají samostatné nastavení níže.",
                .trackpadVerticalDirectionTitle: "Svislý směr trackpadu a Magic Mouse",
                .trackpadVerticalDirectionNatural: "Prst nahoru -> Další stránka / Zobrazit položky níže",
                .trackpadVerticalDirectionReversed: "Prst nahoru -> Předchozí stránka / Zobrazit položky výše",
            ...
            .loadingApplications: "Načítání aplikací…",
                ...
                .backgroundImageTitle: "Použít obrázek na pozadí",
                .backgroundImageSourceTitle: "Zdroj obrázku",
                .backgroundImageSourceTitleCompact: "Zdroj",
                .backgroundImageSourceDesktopPreview: "Statický náhled",
                .wallpaperPreviewHint: "Nevyžaduje oprávnění k záznamu obrazovky. Animované tapety používají statický náhled, který se může lišit od plochy. U některých tapet nemusí být náhled dostupný.",
                .backgroundImageSourceDesktopWallpaper: "Tapeta plochy",
                .backgroundImageSourceCustomImage: "Vlastní obrázek",
                .backgroundImageSourceCustomImageCompact: "Vlastní obrázek",
                .wallpaperCaptureStatic: "Tento obrázek tapety lze načíst přímo bez oprávnění k záznamu obrazovky.",
                .wallpaperCaptureGranted: "Záznam obrazovky pro snímání tapety je povolen.",
                .wallpaperCaptureRequired: "Pořízení snímku této tapety vyžaduje oprávnění k záznamu obrazovky.",
                .wallpaperCaptureAllow: "Povolit snímání tapety",
                .wallpaperCaptureOpenSettings: "Otevřít Nastavení systému",
                .wallpaperCaptureHint: "Při otevření LaunchNext pořídí jeden snímek tapety. macOS udělí přístup k záznamu obrazovky; LaunchNext jej používá pouze pro tapetu. Opětovným výběrem povolíte přístup nebo otevřete Nastavení systému.",
                .chooseBackgroundImage: "Vybrat obrázek…",
                .changeBackgroundImage: "Změnit…",
                .backgroundImageUnavailable: "Obrázek není k dispozici",
                .windowOpenAnimationTitle: "Animace otevření/zavření okna",
                .windowMaxWidthTitle: "Maximální šířka okna",
                .backgroundStyleOptionUnfiltered: "Bez efektu",
                .backgroundStyleUnfilteredMemoryHint: "Ostřejší pozadí může využívat více paměti.",
                .backgroundStyleUnfilteredRequiresImage: "Pro výběr možnosti Bez efektu zapněte obrázek na pozadí.",
                .windowMaxHeightTitle: "Maximální výška okna",
                .windowSizeAutomatic: "Automaticky",
                .windowSizeLimitHint: "Limity v bodech (pt). Prázdné pole nebo 0 znamená automatickou velikost. Vlastní limity začínají na šířce 800 a výšce 600. Okno zachová poměr 4:3; limity pouze zmenšují automatickou velikost.",
                .windowShadowTitle: "Stín okna",
                .windowShadowHint: "Vypnutí může na některých systémech omezit černé okraje efektu Liquid Glass.",
                .windowAnimationDurationLabel: "Délka animace okna",
                ...
                .gestureInputDeviceShowAllTitle: "Zobrazit všechna vstupní zařízení",
                .gestureInputDeviceRecommendedBadge: "Doporučeno",
                .gestureInputDeviceUnverifiedBadge: "Neověřeno",
                .gestureInputDeviceNoRecommendedDescription: "Nebyl nalezen žádný doporučený trackpad. Zapněte Zobrazit všechna vstupní zařízení a otestujte jiné vícedotykové zařízení.",
                .gestureInputDeviceUnverifiedWarning: "Toto zařízení nemusí být trackpad. Vyberte ho jen pro testování.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Složky Liquid Glass",
                .folderLiquidGlassHint: "Použije průhledný Liquid Glass pro ikony složek při vykreslování Core Animation. Vypnutím obnovíte původní vzhled.",
                .folderQuickLaunchTitle: "Rychlé spuštění ze složky",
                .folderQuickLaunchHint: "Kliknutím pravým tlačítkem na složku přímo otevřete aplikace v ní. Ve složce klikněte pravým tlačítkem na aplikaci a připněte ji nahoru. Připnutí je součástí rozložení; počty spuštění ani historie používání se nezaznamenávají.",
            ...
            .german: [
                ...
                .reverseWheelDirectionCardDescription: "Umkehrungen des Mausrads betreffen nur die Mausradeingabe. Vertikale Gesten von Trackpad und Magic Mouse verwenden die separate Einstellung unten.",
                .trackpadVerticalDirectionTitle: "Vertikale Richtung für Trackpad und Magic Mouse",
                .trackpadVerticalDirectionNatural: "Finger nach oben -> Nächste Seite / Untere Elemente anzeigen",
                .trackpadVerticalDirectionReversed: "Finger nach oben -> Vorherige Seite / Obere Elemente anzeigen",
            ...
            .loadingApplications: "Apps werden geladen…",
                ...
                .backgroundImageTitle: "Bild als Hintergrund verwenden",
                .backgroundImageSourceTitle: "Bildquelle",
                .backgroundImageSourceTitleCompact: "Bildquelle",
                .backgroundImageSourceDesktopPreview: "Statische Vorschau",
                .wallpaperPreviewHint: "Keine Bildschirmaufnahme nötig. Animierte Hintergründe verwenden eine statische Vorschau, die vom Schreibtisch abweichen kann. Für einige Hintergründe ist keine Vorschau verfügbar.",
                .backgroundImageSourceDesktopWallpaper: "Schreibtischbild",
                .backgroundImageSourceCustomImage: "Eigenes Bild",
                .backgroundImageSourceCustomImageCompact: "Eigenes Bild",
                .wallpaperCaptureStatic: "Dieses Hintergrundbild kann ohne Berechtigung zur Bildschirmaufnahme direkt geladen werden.",
                .wallpaperCaptureGranted: "Die Bildschirmaufnahme zum Erfassen des Hintergrundbilds ist erlaubt.",
                .wallpaperCaptureRequired: "Zum Erfassen dieses Hintergrundbilds ist die Berechtigung zur Bildschirmaufnahme erforderlich.",
                .wallpaperCaptureAllow: "Erfassung des Hintergrundbilds erlauben",
                .wallpaperCaptureOpenSettings: "Systemeinstellungen öffnen",
                .wallpaperCaptureHint: "Erstellt beim Öffnen von LaunchNext eine Aufnahme des Hintergrunds. macOS erlaubt die Bildschirmaufnahme; LaunchNext nutzt sie nur für den Hintergrund. Wähle diese Option erneut, um den Zugriff zu erlauben oder die Systemeinstellungen zu öffnen.",
                .chooseBackgroundImage: "Bild auswählen…",
                .changeBackgroundImage: "Ändern…",
                .backgroundImageUnavailable: "Bild nicht verfügbar",
                .windowOpenAnimationTitle: "Fenster-Öffnen/Schließen-Animation",
                .windowMaxWidthTitle: "Maximale Fensterbreite",
                .backgroundStyleOptionUnfiltered: "Ohne Effekt",
                .backgroundStyleUnfilteredMemoryHint: "Schärfere Hintergründe können mehr Speicher benötigen.",
                .backgroundStyleUnfilteredRequiresImage: "Aktiviere Bildhintergründe, um Ohne Effekt auszuwählen.",
                .windowMaxHeightTitle: "Maximale Fensterhöhe",
                .windowSizeAutomatic: "Automatisch",
                .windowSizeLimitHint: "Grenzen in Punkten (pt). Leer lassen oder 0 eingeben für automatische Größe. Benutzerdefinierte Grenzen beginnen bei Breite 800 und Höhe 600. Das Seitenverhältnis bleibt 4:3; Grenzen verkleinern nur die automatische Größe.",
                .windowShadowTitle: "Fensterschatten",
                .windowShadowHint: "Ausschalten kann schwarze Ränder bei Liquid Glass auf manchen Systemen reduzieren.",
                .windowAnimationDurationLabel: "Dauer der Fensteranimation",
                ...
                .gestureInputDeviceShowAllTitle: "Alle Eingabegeräte anzeigen",
                .gestureInputDeviceRecommendedBadge: "Empfohlen",
                .gestureInputDeviceUnverifiedBadge: "Nicht verifiziert",
                .gestureInputDeviceNoRecommendedDescription: "Kein empfohlenes Trackpad gefunden. Aktiviere Alle Eingabegeräte anzeigen, um ein anderes Multitouch-Gerät zu testen.",
                .gestureInputDeviceUnverifiedWarning: "Dieses Gerät ist möglicherweise kein Trackpad. Wähle es nur zum Testen aus.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Liquid Glass für Ordner",
                .folderLiquidGlassHint: "Verwendet transparentes Liquid Glass für Ordnersymbole mit Core-Animation-Darstellung. Ausschalten stellt den bisherigen Stil wieder her.",
                .folderQuickLaunchTitle: "Schnellstart aus Ordnern",
                .folderQuickLaunchHint: "Klicke mit der rechten Maustaste auf einen Ordner, um seine Apps direkt zu öffnen. Klicke im Ordner mit der rechten Maustaste auf eine App, um sie oben anzuheften. Anheftungen gehören zum Layout; Startzahlen und Nutzungsverlauf werden nicht aufgezeichnet.",
            ...
            .russian: [
                ...
                .reverseWheelDirectionCardDescription: "Инверсия колёсика мыши влияет только на ввод колёсика. Вертикальные жесты трекпада и Magic Mouse используют отдельную настройку ниже.",
                .trackpadVerticalDirectionTitle: "Вертикальное направление трекпада и Magic Mouse",
                .trackpadVerticalDirectionNatural: "Палец вверх -> Следующая страница / Показать элементы ниже",
                .trackpadVerticalDirectionReversed: "Палец вверх -> Предыдущая страница / Показать элементы выше",
            ...
            .customTitleEmptyTitle: "Пользовательских названий пока нет",
                ...
                .backgroundImageTitle: "Использовать изображение как фон",
                .backgroundImageSourceTitle: "Источник изображения",
                .backgroundImageSourceTitleCompact: "Источник",
                .backgroundImageSourceDesktopPreview: "Предпросмотр",
                .wallpaperPreviewHint: "Разрешение на запись экрана не требуется. Для анимированных обоев используется статичный предпросмотр, который может отличаться от рабочего стола. Для некоторых обоев предпросмотр недоступен.",
                .backgroundImageSourceDesktopWallpaper: "Обои рабочего стола",
                .backgroundImageSourceCustomImage: "Пользовательское изображение",
                .backgroundImageSourceCustomImageCompact: "Своё изображение",
                .wallpaperCaptureStatic: "Это изображение обоев можно прочитать напрямую без разрешения на запись экрана.",
                .wallpaperCaptureGranted: "Запись экрана для захвата обоев разрешена.",
                .wallpaperCaptureRequired: "Для захвата этих обоев требуется разрешение на запись экрана.",
                .wallpaperCaptureAllow: "Разрешить захват обоев",
                .wallpaperCaptureOpenSettings: "Открыть Системные настройки",
                .wallpaperCaptureHint: "При открытии LaunchNext создаётся один снимок обоев. macOS разрешает запись экрана; LaunchNext использует её только для обоев. Выберите этот пункт ещё раз, чтобы разрешить доступ или открыть Системные настройки.",
                .chooseBackgroundImage: "Выбрать изображение…",
                .changeBackgroundImage: "Изменить…",
                .backgroundImageUnavailable: "Изображение недоступно",
                .windowOpenAnimationTitle: "Анимация открытия/закрытия окна",
                .windowMaxWidthTitle: "Максимальная ширина окна",
                .backgroundStyleOptionUnfiltered: "Без эффекта",
                .backgroundStyleUnfilteredMemoryHint: "Более чёткий фон может использовать больше памяти.",
                .backgroundStyleUnfilteredRequiresImage: "Включите фоновое изображение, чтобы выбрать «Без эффекта».",
                .windowMaxHeightTitle: "Максимальная высота окна",
                .windowSizeAutomatic: "Автоматически",
                .windowSizeLimitHint: "Ограничения в пунктах (pt). Оставьте поле пустым или введите 0 для автоматического размера. Минимальные пределы: ширина 800, высота 600. Окно сохраняет пропорции 4:3; ограничения только уменьшают автоматический размер.",
                .windowShadowTitle: "Тень окна",
                .windowShadowHint: "Отключение может уменьшить артефакты в виде чёрных краёв Liquid Glass в некоторых системах.",
                .windowAnimationDurationLabel: "Длительность анимации окна",
                ...
                .gestureInputDeviceShowAllTitle: "Показать все устройства ввода",
                .gestureInputDeviceRecommendedBadge: "Рекомендуется",
                .gestureInputDeviceUnverifiedBadge: "Не проверено",
                .gestureInputDeviceNoRecommendedDescription: "Рекомендуемый трекпад не найден. Включите показ всех устройств ввода, чтобы проверить другое мультитач-устройство.",
                .gestureInputDeviceUnverifiedWarning: "Это устройство может быть не трекпадом. Выбирайте его только для тестирования.",
                .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
                ...
                .folderLiquidGlassTitle: "Liquid Glass для папок",
                .folderLiquidGlassHint: "Прозрачный Liquid Glass для значков папок при отрисовке Core Animation. Отключите, чтобы вернуть прежний стиль.",
                .folderQuickLaunchTitle: "Быстрый запуск из папки",
                .folderQuickLaunchHint: "Щёлкните папку правой кнопкой мыши, чтобы сразу открыть приложения в ней. Внутри папки щёлкните приложение правой кнопкой, чтобы закрепить его сверху. Закрепления относятся к макету; число запусков и история использования не записываются.",
        ...
        builder[.english]?.merge([
            ...
            .contextMenuShowInLayout: "Show in Layout",
            .contextMenuShowInFinder: "Show in Finder",
            .contextMenuCopyAppPath: "Copy App Path",
            .contextMenuPinToFolderQuickLaunchTop: "Pin to Quick Launch Top",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Unpin from Quick Launch Top",
        ...
        builder[.simplifiedChinese]?.merge([
            ...
            .contextMenuShowInLayout: "在布局中显示",
            .contextMenuShowInFinder: "在访达中显示",
            .contextMenuCopyAppPath: "复制应用路径",
            .contextMenuPinToFolderQuickLaunchTop: "固定到快捷启动顶部",
            .contextMenuUnpinFromFolderQuickLaunchTop: "从快捷启动顶部取消固定",
        ...
        builder[.traditionalChinese] = [
            .noAppsFound: "找不到任何應用",
            .searchPlaceholder: "搜尋",
            .appTitle: "LaunchNext",
            .modifiedFrom: "基於 LaunchNow 1.3.1 修改",
            .backgroundHint: "保持後台執行：可將 LaunchNext 固定在 Dock 或使用快速鍵開啟視窗",
            .classicMode: "經典 Launchpad（全螢幕）",
            .iconSize: "圖示大小",
            .iconsPerRow: "每行圖示數量",
            .rowsPerPage: "每頁行數",
            .iconHorizontalSpacing: "橫向間距",
            .iconVerticalSpacing: "縱向間距",
            .labelFontSize: "標籤字型大小",
            .iconLabelFontWeight: "圖示文字粗細",
            .folderDropZoneSize: "資料夾目標區域大小",
            .folderDropZoneSizeHint: "減小該值可降低在視窗模式拖動時誤建資料夾的機率。",
            ...
            .layoutModeScopeCompact: "緊湊",
            .indicatorOfflineDisplay: "離線顯示器",
            .indicatorOfflineBadge: "離線",
            .indicatorScreenIDFormat: "ID %@",
            .defaultOption: "預設",
            .customOption: "自訂",
            .perDisplayIndicatorPositionTitle: "按顯示器分別設定指示器位置",
            .perDisplayIndicatorPositionDescription: "為每臺顯示器使用不同的數值。",
            .applyDefaultsToCurrentDisplay: "將預設值應用到目前顯示器",
            .globalShortcutTitle: "快速鍵與手勢",
            .globalShortcutDescription: "使用全域快速鍵可快速開啟或關閉 LaunchNext。",
            .shortcutSetButton: "設定快速鍵",
            .shortcutSaveButton: "儲存",
            .shortcutClearButton: "清除",
            .shortcutNotSet: "未設定",
            .shortcutListening: "等待按鍵…",
            .shortcutCapturePrompt: "按下想要的快速鍵組合，按 Esc 取消。",
            .shortcutNoModifierWarning: "未使用修飾鍵可能與其他應用衝突。",
            .dockDragSectionTitle: "拖曳應用到 Dock",
            .dockDragSectionDescription: "選擇拖曳到 Dock 的觸發邊，並設定在 LaunchNext 交給 macOS 前需要拖動的距離。",
            ...
            .hotCornerSectionTitle: "熱角",
            .hotCornerSectionDescription: "當指標到達所選螢幕角落時開啟 LaunchNext。",
            .hotCornerEnabledTitle: "啟用熱角",
            .hotCornerPositionTitle: "角落位置",
            .hotCornerTriggerDelayTitle: "觸發延遲",
            .hotCornerHitboxSizeTitle: "觸發區域",
            .hotCornerToggleWhenOpenTitle: "已開啟時關閉",
            .gestureSectionTitle: "手勢",
            .gestureSectionDescription: "實驗性觸控板捏合與輕點手勢，可用於 LaunchNext。",
            ...
            .gestureInputDeviceModeAuto: "自動",
            .gestureInputDeviceModeSelected: "選定裝置",
            ...
            .gestureInputDeviceExternalBadge: "外接",
            .gestureInputDeviceShowAllTitle: "顯示所有輸入裝置",
            .gestureInputDeviceRecommendedBadge: "建議",
            .gestureInputDeviceUnverifiedBadge: "未驗證",
            .gestureInputDeviceNoRecommendedDescription: "找不到建議的觸控板。開啟「顯示所有輸入裝置」可測試其他多點觸控裝置。",
            .gestureInputDeviceUnverifiedWarning: "此裝置可能不是觸控板，僅建議用於測試。",
            .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
            .gestureInputDeviceUnavailableDescription: "部分已選裝置目前不可用。請重新連線它們或改選其他觸控板。",
            .gestureSystemHintTitle: "觸控板設定",
            .gestureSystemHintBody: "使用此手勢前，請先在 系統設定 > 觸控板 > 更多手勢 中關閉“顯示桌面”。",
            .hotCornerPositionTopLeft: "左上角",
            .hotCornerPositionTopRight: "右上角",
            .hotCornerPositionBottomLeft: "左下角",
            .hotCornerPositionBottomRight: "右下角",
            ...
            .predictDrop: "啟用落點預判",
            .showLabels: "顯示圖示文字",
            .useLocalizedThirdPartyTitles: "使用本地化應用名稱",
            .enableAnimations: "啟用滑動動畫",
            .backgroundImageTitle: "使用圖片背景",
            .backgroundImageSourceTitle: "背景來源",
            .backgroundImageSourceTitleCompact: "背景來源",
            .backgroundImageSourceDesktopPreview: "靜態預覽",
            .wallpaperPreviewHint: "無需螢幕錄製權限。動態背景使用靜態預覽，可能與桌面畫面不同；部分背景可能無法讀取預覽。",
            .backgroundImageSourceDesktopWallpaper: "桌面背景",
            .backgroundImageSourceCustomImage: "自選圖片",
            .backgroundImageSourceCustomImageCompact: "自選圖片",
            .wallpaperCaptureStatic: "這張桌布圖片可以直接讀取，無需螢幕錄製權限。",
            .wallpaperCaptureGranted: "已允許取得桌面背景。",
            .wallpaperCaptureRequired: "取得這張桌布需要螢幕錄製權限。",
            .wallpaperCaptureAllow: "允許取得桌面背景",
            .wallpaperCaptureOpenSettings: "開啟系統設定",
            .wallpaperCaptureHint: "開啟 LaunchNext 時擷取一張背景快照。macOS 授予螢幕錄製權限；LaunchNext 僅用於擷取背景。再次點選此選項可授權或前往系統設定。",
            .chooseBackgroundImage: "選擇圖片…",
            .changeBackgroundImage: "更換…",
            .backgroundImageUnavailable: "圖片無法使用",
            .windowOpenAnimationTitle: "視窗開關動畫",
            .windowMaxWidthTitle: "視窗最大寬度",
            .backgroundStyleOptionUnfiltered: "無效果",
            .backgroundStyleUnfilteredMemoryHint: "更清晰的背景可能增加記憶體用量。",
            .backgroundStyleUnfilteredRequiresImage: "開啟「使用圖片背景」後可選擇無效果。",
            .windowMaxHeightTitle: "視窗最大高度",
            .windowSizeAutomatic: "自動",
            .windowSizeLimitHint: "單位為邏輯點（pt）。留空或輸入 0 使用自動大小；自訂上限最低為寬 800、高 600。視窗保持 4:3，上限只會縮小自動計算的尺寸。",
            .windowShadowTitle: "視窗陰影",
            .windowShadowHint: "關閉可緩解部分系統上的液態玻璃黑邊。",
            .windowAnimationDurationLabel: "視窗動畫時長",
            ...
            .reverseWheelDirectionCardDescription: "滑鼠滾輪反轉僅影響滾輪輸入；觸控板和 Magic Mouse 垂直手勢使用下方單獨設定。",
            .trackpadVerticalDirectionTitle: "觸控板與 Magic Mouse 垂直方向",
            .trackpadVerticalDirectionNatural: "手指向上移動 -> 下一頁 / 查看下方內容",
            .trackpadVerticalDirectionReversed: "手指向上移動 -> 上一頁 / 查看上方內容",
            .hideDockOption: "隱藏 Dock",
            .hideMenuBarOption: "全螢幕時隱藏選單列",
            .hideMenuBarInfoBody: "開啟後 Dock 也會一起隱藏。macOS 要求隱藏選單列時必須同時隱藏 Dock。",
            .hoverMagnification: "懸停放大效果",
            .hoverMagnificationScale: "懸停放大倍率",
            .activePressEffect: "按下縮放反饋",
            ...
            .folderLiquidGlassTitle: "資料夾液態玻璃",
            .folderLiquidGlassHint: "為 Core Animation 繪製的資料夾圖示使用通透液態玻璃。關閉後恢復原有樣式。",
            .folderQuickLaunchTitle: "資料夾快速啟動",
            .folderQuickLaunchHint: "在資料夾上按右鍵即可直接開啟其中的 App；在資料夾內對 App 按右鍵可將其釘選到列表頂端。釘選屬於版面設定，不會記錄啟動次數或使用紀錄。",
            .folderLayoutTitle: "資料夾佈局",
            .folderLayoutDescription: "選擇資料夾內應用的顯示方式。",
            .folderLayoutPaged: "分頁",
            .folderLayoutVertical: "縱向滾動",
            .animationDurationLabel: "滑動動畫時長",
            .gridSizeChangeWarning: "調整網格設定可能導致部分圖示位置發生變化。",
            .viewOnGitHub: "開啟專案連結",
            ...
            .importTip: "提示：點選“匯入系統 Launchpad”即可直接匯入原生佈局。",
            .onboardingTitle: "先完成 LaunchNext 初始設定",
            .onboardingSubtitle: "先選一項初始化操作，再開始載入並渲染全部應用圖示。",
            .onboardingFlowWelcomeTitle: "歡迎來到 LaunchNext",
            .onboardingFlowWelcomeSubtitle: "您的 LaunchNext，您來定義。",
            ...
            .onboardingFlowIntroSubtitle: "首次啟動建議先完成這幾個初始化操作。你可以隨時跳過，後續在設定中繼續。",
            .onboardingFlowIntroImportItem: "匯入系統佈局",
            .onboardingFlowIntroPresetItem: "應用經典預設",
            .onboardingFlowIntroShortcutItem: "設定全域快速鍵",
            .onboardingFlowLayoutStepTitle: "第 1 步：初始化佈局",
            .onboardingFlowLayoutStepSubtitle: "匯入系統佈局和經典佈局預設二選一，也可以直接下一步。",
            .onboardingFlowLayoutChooseMethod: "選擇一種初始化方式",
            .onboardingFlowLayoutOptionATitle: "方式 A",
            .onboardingFlowLayoutOptionASubtitle: "匯入系統 Launchpad",
            .onboardingFlowLayoutOptionADetail: "位置最接近你目前系統佈局。",
            .onboardingFlowLayoutOptionAUnavailableDetail: "未檢測到可匯入的系統資料庫。",
            .onboardingFlowLayoutOptionAButton: "使用系統佈局",
            .onboardingFlowLayoutOptionAUnavailableButton: "目前不可用",
            .onboardingFlowLayoutOptionBTitle: "方式 B",
            .onboardingFlowLayoutOptionBSubtitle: "應用經典佈局預設",
            ...
            .onboardingFlowShortcutStepTitle: "第 2 步：設定全域快速鍵",
            .onboardingFlowShortcutStepSubtitle: "設定快速鍵後可以隨時喚出 LaunchNext，不用回到應用視窗。",
            .onboardingFlowShortcutStepButton: "去設定快速鍵",
            .onboardingFlowCompletionHeadline: "開源、輕量、可定製",
            .onboardingFlowCompletionDescription: "你的應用佈局，現在由你定義。",
            .onboardingFlowSidebarStart: "開始",
            .onboardingFlowSidebarLayout: "佈局",
            .onboardingFlowSidebarShortcut: "快速鍵",
            .onboardingFlowSidebarDone: "完成",
            .exportData: "匯出資料",
            .importData: "匯入資料",
            .dataManagementTitle: "資料管理",
            .layoutPresetTitle: "預設佈局",
            .layoutPresetDescription: "應用一套 macOS 26 風格的預設排列。缺失應用會自動跳過，剩餘應用會追加到後面。",
            .layoutPresetApplyButton: "應用經典佈局預設",
            .layoutPresetAppliedTitle: "已應用預設",
            .layoutPresetAppliedMessage: "預設佈局已應用到目前應用列表。",
            ...
            .scanSourcesIntroDescription: "在這裡新增外接磁碟或自訂資料夾，讓其中的應用自動顯示在 LaunchNext。",
            .scanSourcesPlaceholder: "功能即將上線：可在此新增或移除自訂目錄，LaunchNext 會自動掃描並保持同步。",
            .scanSourcesDefaultListTitle: "系統目錄",
            .scanSourcesCustomListTitle: "自訂目錄",
            .scanSourcesAddButton: "新增目錄…",
            .scanSourcesResetButton: "恢復預設",
            .scanSourcesEmptyHint: "還沒有自訂目錄，新增後可同步更多應用。",
            .scanSourcesMissingBadge: "未掛載",
            .scanSourcesFuzzySearchTitle: "模糊搜尋",
            .scanSourcesFuzzySearchDescription: "在啟動器搜尋結果中使用模糊匹配。",
            .scanSourcesSearchDelayTitle: "搜尋延遲",
            .scanSourcesSearchDelayDescription: "設定啟動器搜尋在更新結果前等待的時間。",
            .missingAppBadge: "離線",
            .resetLayout: "重設佈局",
            .resetAppearanceSettings: "重設外觀標籤頁設定",
            .resetAlertTitle: "確認要重設佈局？",
            .resetAlertMessage: "這將完全重設佈局：刪除所有資料夾、清除儲存順序並重新掃描應用。所有自訂都會丟失。",
            .resetAppearanceAlertTitle: "重設外觀標籤頁設定？",
            .resetAppearanceAlertMessage: "這會將“外觀”標籤頁中的設定恢復為預設值，但不會更改你的佈局或資料夾。",
            .resetConfirm: "重設",
            .cancel: "取消",
            .quit: "退出",
            ...
            .settingsSectionHiddenApps: "隱藏應用",
            ...
            .backupDeleteSelectedButton: "刪除所選",
            .backupCleanupDisclosureTitle: "清理無用歷史（高階）",
            .backupCleanupIntroPrimary: "LaunchNext 會在資料庫中保留本地變更歷史。應用本身不會使用它，但它會隨著時間增長。",
            .backupCleanupIntroSecondary: "我們不在應用內執行該操作，因為它具有破壞性且需要關閉資料庫。在終端機手動執行可避免誤操作。",
            .backupCleanupWarning: "重要：執行前請退出 LaunchNext，否則資料庫可能被佔用。",
            .backupCleanupInstruction: "在終端機執行以下命令以清理歷史記錄並收縮資料庫。",
            .backupCleanupCopyButton: "複製",
            .backupCleanupCopiedLabel: "已複製",
            .backupCleanupCommandDetails: "命令說明：`PRAGMA wal_checkpoint(FULL)` 重新整理 WAL，`DELETE FROM ACHANGE` 刪除歷史記錄，`VACUUM` 回收空間。",
            .backupNoFolderSelected: "未選擇備份資料夾。",
            .backupNoBackupsFound: "未找到備份。",
            ...
            .developmentEnableCLICodeHint: "關閉後將阻止終端機 CLI/TUI 訪問。僅在開發測試時開啟。",
            .commandLineInterfaceHelpTitle: "命令列介面",
            .commandLineInterfaceHelpBody: "開啟後會向終端機環境寫入 launchnext 的名字；關閉時會自動移除。\nCLI：LaunchNext --cli help\nTUI：LaunchNext --tui",
            .commandLineInterfaceShowFullPathCommand: "顯示完整可執行路徑命令",
            .commandLineInterfaceAgentHint: "這個功能主要是給 Agent 用的。",
            .commandLineInterfaceRemoveCommandButton: "移除已寫入名字",
            .commandLineInterfaceRemoveCommandDone: "已移除已寫入名字。",
            .commandLineInterfaceRemoveCommandMissing: "未找到受管控的已寫入名字。",
            .commandLineInterfaceRemoveCommandInfoTitle: "這個按鈕會執行什麼",
            .commandLineInterfaceRemoveCommandInfoBody: "該按鈕只會刪除受管控的 LaunchNext CLI shim（不會刪無關檔案）：\nrm /opt/homebrew/bin/launchnext\nrm /usr/local/bin/launchnext\nrm ~/.local/bin/launchnext\nrm ~/bin/launchnext\n然後會從 ~/.zprofile 裡移除 LaunchNext 的 PATH 片段。",
            .developmentForceOnboardingButton: "強制顯示引導",
            .developmentForceOnboardingHint: "僅支援經典 Launchpad（全螢幕）模式。用於測試：會先關閉設定，再立即彈出 onboarding。",
            .gameControllerPlaceholderTitle: "控制器支援",
            .gameControllerPlaceholderSubtitle: "連線控制器即可像方向鍵一樣瀏覽應用，後續將提供更多可設定項。",
            .gameControllerToggleTitle: "啟用控制器導航",
            .gameControllerStatusDisabled: "控制器導航已關閉。",
            .gameControllerStatusNoController: "暫未檢測到任何控制器。",
            .gameControllerStatusConnectedFormat: "已連線控制器：%@",
            .gameControllerQuickGuideTitle: "基礎操作",
            ...
            .gameControllerMenuToggleSubtitle: "效果等同快速鍵（開啟/關閉）。",
            ...
            .voiceToggleDescription: "使用鍵盤或控制器導航時由 Voice Over 朗讀目前應用名稱。",
            .voiceNoteMutualExclusive: "啟用 Voice Over 後將以語音取代導航音效。",
            .voiceAnnouncementAppFormat: "%@",
            .voiceAnnouncementFolderFormat: "資料夾：%@",
            .accessibilityPlaceholderTitle: "可訪問性設定",
            .accessibilityPlaceholderSubtitle: "我們還在設計相關選項，敬請期待。",
            .hiddenAppsAddButton: "隱藏應用",
            .hiddenAppsEmptyTitle: "尚未隱藏任何應用",
            .hiddenAppsEmptySubtitle: "選擇一個應用即可將其從 LaunchNext 網格中隱藏。",
            .hiddenAppsHint: "被隱藏的應用不會顯示在網格中，可在此處取消隱藏。",
            .hiddenAppsRemoveButton: "取消隱藏",
            .hiddenAppsSearchPlaceholder: "搜尋隱藏的應用",
            .notHiddenAppsTitle: "未隱藏應用",
            .notHiddenAppsHint: "選擇一個應用將其從 LaunchNext 隱藏。",
            .notHiddenAppsSearchPlaceholder: "篩選未隱藏的應用",
            .contextMenuShowInLayout: "在佈局中顯示",
            .contextMenuShowInFinder: "在Finder中顯示",
            .contextMenuCopyAppPath: "複製應用路徑",
            .contextMenuPinToFolderQuickLaunchTop: "釘選到快速啟動頂端",
            .contextMenuUnpinFromFolderQuickLaunchTop: "從快速啟動頂端取消釘選",
            .contextMenuRenameFolder: "重新命名資料夾",
            .contextMenuDissolveFolder: "解散資料夾",
            .contextMenuUninstallWithConfiguredTool: "用已設定解除安裝工具解除安裝",
            .contextMenuBatchSelectApps: "批次選擇應用",
            ...
            .uninstallToolChooseButton: "選擇應用…",
            .uninstallToolClearButton: "清除",
            .uninstallToolOpenButton: "開啟解除安裝工具",
            .uninstallToolPanelTitle: "選擇解除安裝工具應用",
            .performancePlaceholderTitle: "效能面板",
            .performancePlaceholderSubtitle: "效能指標將很快展示在此。",
            .performanceModeTitle: "效能模式",
            .performanceModeSubtitle: "在遺留引擎與 Next 引擎之間切換。",
            .performanceModeFull: "遺留引擎",
            .performanceModeLean: "Next 引擎",
            .performanceModeDescriptionFull: "遺留引擎保留舊版快取邏輯，穩定優先。",
            .performanceModeDescriptionLean: "Next 引擎更省記憶體，降低卡頓。",
            .performanceRendererRecommendation: "強烈推薦使用此引擎。",
            .performanceModeRestartHint: "切換後需重啟才能生效。",
            .performanceModeRestartTitle: "需要重啟",
            .performanceModeRestartMessage: "請重啟 LaunchNext 以應用新的效能模式。",
            .performanceRendererTitle: "Next 引擎 + Core Animation",
            ...
            .performanceOverviewSubtitle: "快速檢視記憶體與快取狀態。",
            .performanceMemoryLabel: "記憶體佔用",
            .performanceCacheTitle: "快取狀態",
            .performanceCacheStatusValid: "快取可用",
            .performanceCacheStatusInvalid: "快取生成中",
            .performanceCacheLastUpdateLabel: "最後更新",
            .performanceCacheNever: "從未",
            .performanceCacheClearButton: "清理快取",
            .performanceCacheIconLabel: "圖示快取",
            .performanceCacheAppInfoLabel: "應用資訊快取",
            .performanceCacheGridLabel: "網格快取",
            .performanceCacheTotalLabel: "總快取",
            .performanceCacheCountsHint: "這些數字表示快取條目數量，並非記憶體大小。",
            .performanceCacheIconsDisabled: "Next 引擎已關閉",
            .performanceCacheLeanHint: "Next 引擎下會跳過圖示快取，以降低記憶體佔用與卡頓。",
            .performanceModeRecommendation: "預設推薦啟用 Next 引擎（更省記憶體、降低卡頓）。",
            .renameSearchPlaceholder: "搜尋應用",
            .customTitlePlaceholder: "輸入自訂名稱",
            .customTitleHint: "在這裡為任意應用重新命名；即使重新匯入或切換本地化也會保留。",
            .customTitleDefaultFormat: "預設：%@",
            .customTitleReset: "恢復預設",
            .customTitleAddButton: "新增應用",
            .customTitleAddFromFolder: "新增應用",
            .loadMore: "載入更多",
            .customTitleEmptyTitle: "目前沒有自訂名稱",
            .customTitleEmptySubtitle: "點選按鈕選擇應用即可開始重新命名；重新匯入或切換語言都會保留這些設定。",
            .customTitleNoResults: "沒有匹配項",
            .customTitlePickerMessage: "選擇一個應用來管理顯示名稱。",
            .customTitleEdit: "編輯",
            .customTitleSave: "儲存",
            .customTitleCancel: "取消",
            .customTitleOnly: "僅顯示已編輯名稱的應用。",
            .loadingApplications: "正在載入應用…",
            .showFPSOverlay: "顯示 FPS",
            .showFPSOverlayDisclaimer: "目前數值僅供參考，可能與實際幀率存在差異。",
            .showFPSOverlayWarning: "開啟後會顯著增加 CPU 和記憶體佔用，這是測試功能，日常請勿開啟。",
            .customIconTitle: "應用圖示",
            .customIconChoose: "選擇…",
            ...
            .languageNameFrench: "法文",
            .languageNameSpanish: "西班牙文",
            .languageNameItalian: "義大利文",
            .languageNameCzech: "捷克文",
            .languageNameGerman: "德文",
            .languageNameRussian: "俄文",
            .languageNameHindi: "印地文",
            .languageNameVietnamese: "越南文",
            .languageNamePortugueseBrazil: "葡萄牙文（巴西）",
            .folderNamePlaceholder: "資料夾名稱",
            .chooseButton: "選擇",
            .exportPanelMessage: "選擇一個目標資料夾匯出 LaunchNext 資料",
            .importPrompt: "匯入",
            .importPanelMessage: "請選擇之前由 LaunchNext 匯出的資料夾",
            .legacyArchivePanelMessage: "請選擇 Legacy Launchpad 歸檔（.lmy/.zip）或 db 檔案",
            ...
            .updaterConfirmMessage: "LaunchNext 將會退出並在終端機中執行更新器。安裝完成後會自動重新啟動。\n\n如果右側的“下載更新”按鈕是透明的，請直接點選。\n這是 macOS 的 bug。⬇️",
            .updaterTerminalHint: "更新會在終端機中執行，LaunchNext 將退出並自動重新啟動。",
            .updaterLaunchFailed: "無法啟動更新器（%@）。",
            .updaterMissingBinary: "App 套件內找不到更新器。",
            .updaterNotExecutable: "更新器檔案不可執行。",
            .updaterHoldPrompt: "更新完成後，按 Enter 鍵關閉視窗，LaunchNext 會自動重新開啟。",
        ]
        ...
        builder[.japanese]?.merge([
            ...
            .contextMenuShowInLayout: "レイアウト内で表示",
            .contextMenuShowInFinder: "Finderで表示",
            .contextMenuCopyAppPath: "アプリのパスをコピー",
            .contextMenuPinToFolderQuickLaunchTop: "クイック起動の先頭に固定",
            .contextMenuUnpinFromFolderQuickLaunchTop: "クイック起動の先頭から固定解除",
        ...
        builder[.korean]?.merge([
            ...
            .contextMenuShowInLayout: "레이아웃에서 보기",
            .contextMenuShowInFinder: "Finder에서 보기",
            .contextMenuCopyAppPath: "앱 경로 복사",
            .contextMenuPinToFolderQuickLaunchTop: "빠른 실행 맨 위에 고정",
            .contextMenuUnpinFromFolderQuickLaunchTop: "빠른 실행 맨 위에서 고정 해제",
        ...
        builder[.vietnamese]?.merge([
            ...
            .contextMenuShowInLayout: "Hiển thị trong bố cục",
            .contextMenuShowInFinder: "Hiển thị trong Finder",
            .contextMenuCopyAppPath: "Sao chép đường dẫn ứng dụng",
            .contextMenuPinToFolderQuickLaunchTop: "Ghim lên đầu Khởi chạy nhanh",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Bỏ ghim khỏi đầu Khởi chạy nhanh",
        ...
        builder[.french]?.merge([
            ...
            .contextMenuShowInLayout: "Afficher dans la disposition",
            .contextMenuShowInFinder: "Afficher dans le Finder",
            .contextMenuCopyAppPath: "Copier le chemin de l’app",
            .contextMenuPinToFolderQuickLaunchTop: "Épingler en haut du lancement rapide",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Désépingler du haut du lancement rapide",
        ...
        builder[.spanish]?.merge([
            ...
            .settingsSectionUninstall: "Desinstalador",
            .contextMenuShowInLayout: "Mostrar en la distribución",
            .contextMenuShowInFinder: "Mostrar en Finder",
            .contextMenuCopyAppPath: "Copiar ruta de la app",
            .contextMenuPinToFolderQuickLaunchTop: "Fijar arriba en el inicio rápido",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Desfijar de arriba en el inicio rápido",
        ...
        builder[.italian]?.merge([
            ...
            .settingsSectionTitles: "Nomi delle app",
            ...
            .backupCleanupDisclosureTitle: "Cancella cronologia inutilizzata (Avanzate)",
            ...
            .developmentEnableCLICodeHint: "Quando è disattivata, l'accesso tramite terminale CLI/TUI è bloccato. Mantieni l'opzione disattivata a meno che tu non stia eseguendo dei test.",
            .commandLineInterfaceHelpTitle: "Interfaccia a riga di comando",
            .commandLineInterfaceHelpBody: "Attivando questa opzione, il nome `launchnext` verrà scritto nel path della tua shell. Disattivandola, verrà rimosso.\nCLI: LaunchNext --cli help\nTUI: LaunchNext --tui",
            .commandLineInterfaceShowFullPathCommand: "Mostra comando percorso completo eseguibile",
            .commandLineInterfaceAgentHint: "Questa funzionalità è pensata principalmente per i flussi di lavoro degli Agent.",
            .commandLineInterfaceRemoveCommandButton: "Rimuovi nome inserito",
            .commandLineInterfaceRemoveCommandDone: "Nome inserito rimosso.",
            .commandLineInterfaceRemoveCommandMissing: "Nessun nome inserito gestito trovato.",
            .commandLineInterfaceRemoveCommandInfoTitle: "Dettagli sulle azioni eseguite",
            .commandLineInterfaceRemoveCommandInfoBody: "Questo pulsante rimuove solo gli shim della CLI gestiti da LaunchNext (non i file non correlati):\nrm /opt/homebrew/bin/launchnext\nrm /usr/local/bin/launchnext\nrm ~/.local/bin/launchnext\nrm ~/bin/launchnext\nSuccessivamente, rimuove lo snippet del PATH di LaunchNext da ~/.zprofile.",
            .developmentForceOnboardingButton: "Forza avvio onboarding",
            .developmentForceOnboardingHint: "Solo Launchpad classico (A schermo intero). Chiudi le Impostazioni e mostra immediatamente l'onboarding a scopo di test.",
            ...
            .gameControllerMenuToggleSubtitle: "Funziona come la scorciatoia globale (apri/chiudi).",
            ...
            .contextMenuShowInLayout: "Mostra nella disposizione",
            .contextMenuShowInFinder: "Mostra nel Finder",
            .contextMenuCopyAppPath: "Copia percorso app",
            .contextMenuPinToFolderQuickLaunchTop: "Fissa in alto nell’avvio rapido",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Rimuovi dall’alto dell’avvio rapido",
            ...
            .accessibilityPlaceholderSubtitle: "Le impostazioni di accessibilità sono pianificate; al momento non è presente nulla.",
            ...
            .performanceRendererRecommendation: "Fortemente consigliato",
            .performanceModeRestartHint: "Il cambio di modalità richiede un riavvio per avere effetto.",
            .performanceModeRestartTitle: "Riavvio richiesto",
            .performanceModeRestartMessage: "Riavvia LaunchNext per applicare la nuova modalità prestazioni.",
            ...
            .performanceRendererWarning: "Attivato. Se riscontri problemi, disattiva questa opzione.",
            .performanceOverviewTitle: "Panoramica prestazioni",
            .performanceOverviewSubtitle: "Istantanea dell'uso della memoria e dell'attività della cache.",
            ...
            .performanceCacheCountsHint: "I numeri indicano il conteggio degli elementi, non la dimensione della memoria..",
            .performanceCacheIconsDisabled: "Disattivata in Next Engine",
            .performanceCacheLeanHint: "Next Engine non usa la cache delle icone per ridurre memoria e micro-scatti.",
            .performanceModeRecommendation: "Consigliato: Next Engine per un minor consumo di memoria e prestazioni più fluide.",
        ...
        builder[.czech]?.merge([
            ...
            .contextMenuShowInLayout: "Zobrazit v rozložení",
            .contextMenuShowInFinder: "Zobrazit ve Finderu",
            .contextMenuCopyAppPath: "Kopírovat cestu aplikace",
            .contextMenuPinToFolderQuickLaunchTop: "Připnout nahoru v rychlém spuštění",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Odepnout z horní části rychlého spuštění",
        ...
        builder[.german]?.merge([
            ...
            .contextMenuShowInLayout: "Im Layout anzeigen",
            .contextMenuShowInFinder: "Im Finder anzeigen",
            .contextMenuCopyAppPath: "App-Pfad kopieren",
            .contextMenuPinToFolderQuickLaunchTop: "Oben im Schnellstart anheften",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Oben aus dem Schnellstart lösen",
        ...
        builder[.russian]?.merge([
            ...
            .contextMenuShowInLayout: "Показать в раскладке",
            .contextMenuShowInFinder: "Показать в Finder",
            .contextMenuCopyAppPath: "Скопировать путь приложения",
            .contextMenuPinToFolderQuickLaunchTop: "Закрепить сверху в быстром запуске",
            .contextMenuUnpinFromFolderQuickLaunchTop: "Открепить сверху в быстром запуске",
        ...
        hindiDictionary.merge([
            ...
            .backgroundImageTitle: "चित्र पृष्ठभूमि का उपयोग करें",
            .backgroundImageSourceTitle: "पृष्ठभूमि स्रोत",
            .backgroundImageSourceTitleCompact: "स्रोत",
            .backgroundImageSourceDesktopPreview: "स्थिर पूर्वावलोकन",
            .wallpaperPreviewHint: "स्क्रीन रिकॉर्डिंग की अनुमति आवश्यक नहीं है। एनिमेटेड वॉलपेपर का स्थिर पूर्वावलोकन डेस्कटॉप से अलग हो सकता है। कुछ वॉलपेपर का पूर्वावलोकन उपलब्ध नहीं हो सकता।",
            .backgroundImageSourceDesktopWallpaper: "डेस्कटॉप वॉलपेपर",
            .backgroundImageSourceCustomImage: "कस्टम चित्र",
            .backgroundImageSourceCustomImageCompact: "कस्टम चित्र",
            .wallpaperCaptureStatic: "इस वॉलपेपर चित्र को स्क्रीन रिकॉर्डिंग की अनुमति के बिना सीधे पढ़ा जा सकता है।",
            .wallpaperCaptureGranted: "वॉलपेपर कैप्चर करने के लिए स्क्रीन रिकॉर्डिंग की अनुमति दी गई है।",
            .wallpaperCaptureRequired: "इस वॉलपेपर को कैप्चर करने के लिए स्क्रीन रिकॉर्डिंग की अनुमति चाहिए।",
            .wallpaperCaptureAllow: "वॉलपेपर कैप्चर की अनुमति दें",
            .wallpaperCaptureOpenSettings: "सिस्टम सेटिंग्ज़ खोलें",
            .wallpaperCaptureHint: "LaunchNext खोलने पर वॉलपेपर की एक तस्वीर ली जाती है। macOS स्क्रीन रिकॉर्डिंग की अनुमति देता है; LaunchNext इसका उपयोग केवल वॉलपेपर के लिए करता है। अनुमति देने या सिस्टम सेटिंग्स खोलने के लिए इस विकल्प को फिर से चुनें।",
            .chooseBackgroundImage: "चित्र चुनें…",
            .changeBackgroundImage: "बदलें…",
            .backgroundImageUnavailable: "चित्र उपलब्ध नहीं है",
            .windowOpenAnimationTitle: "विंडो खोलने/बंद करने की एनीमेशन",
            .windowMaxWidthTitle: "विंडो की अधिकतम चौड़ाई",
            .backgroundStyleOptionUnfiltered: "बिना प्रभाव",
            .backgroundStyleUnfilteredMemoryHint: "अधिक स्पष्ट पृष्ठभूमि ज़्यादा मेमोरी का उपयोग कर सकती है।",
            .backgroundStyleUnfilteredRequiresImage: "बिना प्रभाव चुनने के लिए चित्र पृष्ठभूमि चालू करें।",
            .windowMaxHeightTitle: "विंडो की अधिकतम ऊँचाई",
            .windowSizeAutomatic: "स्वचालित",
            .windowSizeLimitHint: "सीमाएँ पॉइंट (pt) में हैं। स्वचालित आकार के लिए खाली छोड़ें या 0 दर्ज करें। कस्टम सीमाएँ कम से कम 800 चौड़ाई और 600 ऊँचाई हैं। विंडो 4:3 अनुपात रखती है; सीमाएँ केवल स्वचालित आकार को घटाती हैं।",
            .windowShadowTitle: "विंडो की छाया",
            .windowShadowHint: "कुछ सिस्टम पर Liquid Glass के काले किनारों की समस्या कम करने के लिए इसे बंद करें।",
            .windowAnimationDurationLabel: "विंडो एनीमेशन अवधि",
            ...
            .reverseWheelDirectionCardDescription: "माउस व्हील उलटना केवल व्हील इनपुट को प्रभावित करता है। ट्रैकपैड और Magic Mouse के वर्टिकल जेस्चर नीचे की अलग सेटिंग का उपयोग करते हैं।",
            .trackpadVerticalDirectionTitle: "ट्रैकपैड और Magic Mouse की वर्टिकल दिशा",
            .trackpadVerticalDirectionNatural: "उंगली ऊपर ले जाएँ -> अगला पेज / नीचे के आइटम दिखाएँ",
            .trackpadVerticalDirectionReversed: "उंगली ऊपर ले जाएँ -> पिछला पेज / ऊपर के आइटम दिखाएँ",
            ...
            .gestureInputDeviceShowAllTitle: "सभी इनपुट डिवाइस दिखाएँ",
            .gestureInputDeviceRecommendedBadge: "अनुशंसित",
            .gestureInputDeviceUnverifiedBadge: "सत्यापित नहीं",
            .gestureInputDeviceNoRecommendedDescription: "कोई अनुशंसित ट्रैकपैड नहीं मिला। किसी दूसरे मल्टीटच डिवाइस को टेस्ट करने के लिए सभी इनपुट डिवाइस दिखाएँ चालू करें।",
            .gestureInputDeviceUnverifiedWarning: "यह डिवाइस ट्रैकपैड नहीं हो सकता। इसे केवल टेस्टिंग के लिए चुनें।",
            .gestureInputDeviceFamilyIDFormat: "FamilyID %d",
            ...
            .folderLiquidGlassTitle: "फ़ोल्डर Liquid Glass",
            .folderLiquidGlassHint: "Core Animation से रेंडर किए गए फ़ोल्डर आइकन के लिए पारदर्शी Liquid Glass इस्तेमाल करें। बंद करने पर पुरानी शैली वापस आती है।",
            .folderQuickLaunchTitle: "फ़ोल्डर क्विक लॉन्च",
            .folderQuickLaunchHint: "फ़ोल्डर के ऐप्स सीधे खोलने के लिए उस पर राइट-क्लिक करें। फ़ोल्डर के अंदर किसी ऐप को सूची के शीर्ष पर पिन करने के लिए उस पर राइट-क्लिक करें। पिन लेआउट सेटिंग हैं; लॉन्च संख्या या उपयोग इतिहास दर्ज नहीं किया जाता।",
            ...
            .contextMenuShowInLayout: "लेआउट में दिखाएँ",
            .contextMenuShowInFinder: "Finder में दिखाएँ",
            .contextMenuCopyAppPath: "ऐप पथ कॉपी करें",
            .contextMenuPinToFolderQuickLaunchTop: "क्विक लॉन्च के शीर्ष पर पिन करें",
            .contextMenuUnpinFromFolderQuickLaunchTop: "क्विक लॉन्च के शीर्ष से अनपिन करें",
