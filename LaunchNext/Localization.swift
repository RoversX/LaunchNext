...
final class LocalizationManager {
    ...
    private init() {
        ...
        .portugueseBrazil: [
            ...
            .backupPlaceholderTitle: "Backup (em breve)",
            .backupPlaceholderSubtitle: "As opções de backup e restauração aparecerão aqui depois.",
        ...
        builder[.english]?.merge([
            ...
            .backupPlaceholderTitle: "Backup (coming soon)",
            .backupPlaceholderSubtitle: "Backup and restore options will appear here later.",
        ...
        builder[.simplifiedChinese]?.merge([
            ...
            .backupPlaceholderTitle: "备份（即将推出）",
            .backupPlaceholderSubtitle: "稍后会在这里提供备份和还原选项。",
        ...
        builder[.japanese]?.merge([
            ...
            .backupPlaceholderTitle: "バックアップ（近日公開）",
            .backupPlaceholderSubtitle: "ここにバックアップと復元のオプションを追加する予定です。",
        ...
        builder[.korean]?.merge([
            ...
            .backupPlaceholderTitle: "백업(곧 제공)",
            .backupPlaceholderSubtitle: "여기에 백업 및 복원 옵션이 추가될 예정입니다.",
        ...
        builder[.vietnamese]?.merge([
            ...
            .backupPlaceholderTitle: "Sao lưu (sắp có)",
            .backupPlaceholderSubtitle: "Tùy chọn sao lưu và khôi phục sẽ xuất hiện tại đây sau.",
        ...
        builder[.french]?.merge([
            ...
            .backupPlaceholderTitle: "Sauvegarde (bientôt)",
            .backupPlaceholderSubtitle: "Les options de sauvegarde et de restauration arriveront ici plus tard.",
        ...
        builder[.spanish]?.merge([
            ...
            .backupPlaceholderTitle: "Copia de seguridad (próximamente)",
            .backupPlaceholderSubtitle: "Aquí aparecerán más adelante las opciones de copia de seguridad y restauración.",
        ...
        builder[.italian]?.merge([
            ...
            .backupPlaceholderTitle: "Backup (presto disponibile)",
            .backupPlaceholderSubtitle: "Qui arriveranno le opzioni di backup e ripristino.",
        ...
        builder[.czech]?.merge([
            ...
            .backupPlaceholderTitle: "Zálohování (již brzy)",
            .backupPlaceholderSubtitle: "Možnosti zálohy a obnovení se zde objeví později.",
        ...
        builder[.german]?.merge([
            ...
            .backupPlaceholderTitle: "Backup (bald verfügbar)",
            .backupPlaceholderSubtitle: "Optionen für Backup und Wiederherstellung erscheinen später hier.",
        ...
        builder[.russian]?.merge([
            ...
            .backupPlaceholderTitle: "Резервное копирование (скоро)",
            .backupPlaceholderSubtitle: "Здесь позже появятся параметры резервного копирования и восстановления.",
        ...
        hindiDictionary.merge([
            ...
            .backupPlaceholderTitle: "बैकअप (जल्द आ रहा है)",
            .backupPlaceholderSubtitle: "बैकअप और रिस्टोर के विकल्प आगे चलकर यहाँ दिखेंगे।",
