    ...
    private init() {
        ...
        .portugueseBrazil: [
            ...
            .korean: [
                ...
                .showFPSOverlayWarning: "켜면 CPU와 메모리 사용량이 크게 증가할 수 있습니다. 테스트 기능이므로 일반 사용 시에는 끄세요.",
        ...
        builder[.korean]?.merge([
            ...
            .performanceRendererSubtitle: "Next 엔진이 필요합니다.",
            .performanceRendererWarning: "활성화됨. 문제가 있으면 끄세요.",
